...
/* =====================================================================
   ...
   ===================================================================== */
/* =====================================================================
   SAKURA SIGNAL — TARGETED WORLD/PERFORMANCE SUPPORT
   Comprehensive IANA time-zone coordinates + adaptive rendering budget.
   ===================================================================== */
window.__SAKURA_TZ_COORDS__ = Object.freeze({"Europe/Andorra":[42.5,1.5167],"Asia/Dubai":[25.3,55.3],"Asia/Kabul":[34.5167,69.2],"Europe/Tirane":[41.3333,19.8333],"Asia/Yerevan":[40.1833,44.5],"Antarctica/Casey":[-66.2833,110.5167],"Antarctica/Davis":[-68.5833,77.9667],"Antarctica/Mawson":[-67.6,62.8833],"Antarctica/Palmer":[-64.8,-64.1],"Antarctica/Rothera":[-67.5667,-68.1333],"Antarctica/Troll":[-72.0114,2.535],"Antarctica/Vostok":[-78.4,106.9],"America/Argentina/Buenos_Aires":[-34.6,-58.45],"America/Argentina/Cordoba":[-31.4,-64.1833],"America/Argentina/Salta":[-24.7833,-65.4167],"America/Argentina/Jujuy":[-24.1833,-65.3],"America/Argentina/Tucuman":[-26.8167,-65.2167],"America/Argentina/Catamarca":[-28.4667,-65.7833],"America/Argentina/La_Rioja":[-29.4333,-66.85],"America/Argentina/San_Juan":[-31.5333,-68.5167],"America/Argentina/Mendoza":[-32.8833,-68.8167],"America/Argentina/San_Luis":[-33.3167,-66.35],"America/Argentina/Rio_Gallegos":[-51.6333,-69.2167],"America/Argentina/Ushuaia":[-54.8,-68.3],"Pacific/Pago_Pago":[-14.2667,-170.7],"Europe/Vienna":[48.2167,16.3333],"Australia/Lord_Howe":[-31.55,159.0833],"Antarctica/Macquarie":[-54.5,158.95],"Australia/Hobart":[-42.8833,147.3167],"Australia/Melbourne":[-37.8167,144.9667],"Australia/Sydney":[-33.8667,151.2167],"Australia/Broken_Hill":[-31.95,141.45],"Australia/Brisbane":[-27.4667,153.0333],"Australia/Lindeman":[-20.2667,149.0],"Australia/Adelaide":[-34.9167,138.5833],"Australia/Darwin":[-12.4667,130.8333],"Australia/Perth":[-31.95,115.85],"Australia/Eucla":[-31.7167,128.8667],"Asia/Baku":[40.3833,49.85],"America/Barbados":[13.1,-59.6167],"Asia/Dhaka":[23.7167,90.4167],"Europe/Brussels":[50.8333,4.3333],"Europe/Sofia":[42.6833,23.3167],"Atlantic/Bermuda":[32.2833,-64.7667],"America/La_Paz":[-16.5,-68.15],"America/Noronha":[-3.85,-32.4167],"America/Belem":[-1.45,-48.4833],"America/Fortaleza":[-3.7167,-38.5],"America/Recife":[-8.05,-34.9],"America/Araguaina":[-7.2,-48.2],"America/Maceio":[-9.6667,-35.7167],"America/Bahia":[-12.9833,-38.5167],"America/Sao_Paulo":[-23.5333,-46.6167],"America/Campo_Grande":[-20.45,-54.6167],"America/Cuiaba":[-15.5833,-56.0833],"America/Santarem":[-2.4333,-54.8667],"America/Porto_Velho":[-8.7667,-63.9],"America/Boa_Vista":[2.8167,-60.6667],"America/Manaus":[-3.1333,-60.0167],"America/Eirunepe":[-6.6667,-69.8667],"America/Rio_Branco":[-9.9667,-67.8],"Asia/Thimphu":[27.4667,89.65],"Europe/Minsk":[53.9,27.5667],"America/Belize":[17.5,-88.2],"America/St_Johns":[47.5667,-52.7167],"America/Halifax":[44.65,-63.6],"America/Glace_Bay":[46.2,-59.95],"America/Moncton":[46.1,-64.7833],"America/Goose_Bay":[53.3333,-60.4167],"America/Toronto":[43.65,-79.3833],"America/Iqaluit":[63.7333,-68.4667],"America/Winnipeg":[49.8833,-97.15],"America/Resolute":[74.6956,-94.8292],"America/Rankin_Inlet":[62.8167,-92.0831],"America/Regina":[50.4,-104.65],"America/Swift_Current":[50.2833,-107.8333],"America/Edmonton":[53.55,-113.4667],"America/Cambridge_Bay":[69.1139,-105.0528],"America/Inuvik":[68.3497,-133.7167],"America/Dawson_Creek":[55.7667,-120.2333],"America/Fort_Nelson":[58.8,-122.7],"America/Whitehorse":[60.7167,-135.05],"America/Dawson":[64.0667,-139.4167],"America/Vancouver":[49.2667,-123.1167],"Europe/Zurich":[47.3833,8.5333],"Africa/Abidjan":[5.3167,-4.0333],"Pacific/Rarotonga":[-21.2333,-159.7667],"America/Santiago":[-33.45,-70.6667],"America/Coyhaique":[-45.5667,-72.0667],"America/Punta_Arenas":[-53.15,-70.9167],"Pacific/Easter":[-27.15,-109.4333],"Asia/Shanghai":[31.2333,121.4667],"Asia/Urumqi":[43.8,87.5833],"America/Bogota":[4.6,-74.0833],"America/Costa_Rica":[9.9333,-84.0833],"America/Havana":[23.1333,-82.3667],"Atlantic/Cape_Verde":[14.9167,-23.5167],"Asia/Nicosia":[35.1667,33.3667],"Asia/Famagusta":[35.1167,33.95],"Europe/Prague":[50.0833,14.4333],"Europe/Berlin":[52.5,13.3667],"America/Santo_Domingo":[18.4667,-69.9],"Africa/Algiers":[36.7833,3.05],"America/Guayaquil":[-2.1667,-79.8333],"Pacific/Galapagos":[-0.9,-89.6],"Europe/Tallinn":[59.4167,24.75],"Africa/Cairo":[30.05,31.25],"Africa/El_Aaiun":[27.15,-13.2],"Europe/Madrid":[40.4,-3.6833],"Africa/Ceuta":[35.8833,-5.3167],"Atlantic/Canary":[28.1,-15.4],"Europe/Helsinki":[60.1667,24.9667],"Pacific/Fiji":[-18.1333,178.4167],"Atlantic/Stanley":[-51.7,-57.85],"Pacific/Kosrae":[5.3167,162.9833],"Atlantic/Faroe":[62.0167,-6.7667],"Europe/Paris":[48.8667,2.3333],"Europe/London":[51.5083,-0.1253],"Asia/Tbilisi":[41.7167,44.8167],"America/Cayenne":[4.9333,-52.3333],"Europe/Gibraltar":[36.1333,-5.35],"America/Nuuk":[64.1833,-51.7333],"America/Danmarkshavn":[76.7667,-18.6667],"America/Scoresbysund":[70.4833,-21.9667],"America/Thule":[76.5667,-68.7833],"Europe/Athens":[37.9667,23.7167],"Atlantic/South_Georgia":[-54.2667,-36.5333],"America/Guatemala":[14.6333,-90.5167],"Pacific/Guam":[13.4667,144.75],"Africa/Bissau":[11.85,-15.5833],"America/Guyana":[6.8,-58.1667],"Asia/Hong_Kong":[22.2833,114.15],"America/Tegucigalpa":[14.1,-87.2167],"America/Port-au-Prince":[18.5333,-72.3333],"Europe/Budapest":[47.5,19.0833],"Asia/Jakarta":[-6.1667,106.8],"Asia/Pontianak":[-0.0333,109.3333],"Asia/Makassar":[-5.1167,119.4],"Asia/Jayapura":[-2.5333,140.7],"Europe/Dublin":[53.3333,-6.25],"Asia/Jerusalem":[31.7806,35.2239],"Asia/Kolkata":[22.5333,88.3667],"Indian/Chagos":[-7.3333,72.4167],"Asia/Baghdad":[33.35,44.4167],"Asia/Tehran":[35.6667,51.4333],"Europe/Rome":[41.9,12.4833],"America/Jamaica":[17.9681,-76.7933],"Asia/Amman":[31.95,35.9333],"Asia/Tokyo":[35.6544,139.7447],"Africa/Nairobi":[-1.2833,36.8167],"Asia/Bishkek":[42.9,74.6],"Pacific/Tarawa":[1.4167,173.0],"Pacific/Kanton":[-2.7833,-171.7167],"Pacific/Kiritimati":[1.8667,-157.3333],"Asia/Pyongyang":[39.0167,125.75],"Asia/Seoul":[37.55,126.9667],"Asia/Almaty":[43.25,76.95],"Asia/Qyzylorda":[44.8,65.4667],"Asia/Qostanay":[53.2,63.6167],"Asia/Aqtobe":[50.2833,57.1667],"Asia/Aqtau":[44.5167,50.2667],"Asia/Atyrau":[47.1167,51.9333],"Asia/Oral":[51.2167,51.35],"Asia/Beirut":[33.8833,35.5],"Asia/Colombo":[6.9333,79.85],"Africa/Monrovia":[6.3,-10.7833],"Europe/Vilnius":[54.6833,25.3167],"Europe/Riga":[56.95,24.1],"Africa/Tripoli":[32.9,13.1833],"Africa/Casablanca":[33.65,-7.5833],"Europe/Chisinau":[47.0,28.8333],"Pacific/Kwajalein":[9.0833,167.3333],"Asia/Yangon":[16.7833,96.1667],"Asia/Ulaanbaatar":[47.9167,106.8833],"Asia/Hovd":[48.0167,91.65],"Asia/Macau":[22.1972,113.5417],"America/Martinique":[14.6,-61.0833],"Europe/Malta":[35.9,14.5167],"Indian/Mauritius":[-20.1667,57.5],"Indian/Maldives":[4.1667,73.5],"America/Mexico_City":[19.4,-99.15],"America/Cancun":[21.0833,-86.7667],"America/Merida":[20.9667,-89.6167],"America/Monterrey":[25.6667,-100.3167],"America/Matamoros":[25.8333,-97.5],"America/Chihuahua":[28.6333,-106.0833],"America/Ciudad_Juarez":[31.7333,-106.4833],"America/Ojinaga":[29.5667,-104.4167],"America/Mazatlan":[23.2167,-106.4167],"America/Bahia_Banderas":[20.8,-105.25],"America/Hermosillo":[29.0667,-110.9667],"America/Tijuana":[32.5333,-117.0167],"Asia/Kuching":[1.55,110.3333],"Africa/Maputo":[-25.9667,32.5833],"Africa/Windhoek":[-22.5667,17.1],"Pacific/Noumea":[-22.2667,166.45],"Pacific/Norfolk":[-29.05,167.9667],"Africa/Lagos":[6.45,3.4],"America/Managua":[12.15,-86.2833],"Asia/Kathmandu":[27.7167,85.3167],"Pacific/Nauru":[-0.5167,166.9167],"Pacific/Niue":[-19.0167,-169.9167],"Pacific/Auckland":[-36.8667,174.7667],"Pacific/Chatham":[-43.95,-176.55],"America/Panama":[8.9667,-79.5333],"America/Lima":[-12.05,-77.05],"Pacific/Tahiti":[-17.5333,-149.5667],"Pacific/Marquesas":[-9.0,-139.5],"Pacific/Gambier":[-23.1333,-134.95],"Pacific/Port_Moresby":[-9.5,147.1667],"Pacific/Bougainville":[-6.2167,155.5667],"Asia/Manila":[14.5867,120.9678],"Asia/Karachi":[24.8667,67.05],"Europe/Warsaw":[52.25,21.0],"America/Miquelon":[47.05,-56.3333],"Pacific/Pitcairn":[-25.0667,-130.0833],"America/Puerto_Rico":[18.4683,-66.1061],"Asia/Gaza":[31.5,34.4667],"Asia/Hebron":[31.5333,35.095],"Europe/Lisbon":[38.7167,-9.1333],"Atlantic/Madeira":[32.6333,-16.9],"Atlantic/Azores":[37.7333,-25.6667],"Pacific/Palau":[7.3333,134.4833],"America/Asuncion":[-25.2667,-57.6667],"Asia/Qatar":[25.2833,51.5333],"Europe/Bucharest":[44.4333,26.1],"Europe/Belgrade":[44.8333,20.5],"Europe/Kaliningrad":[54.7167,20.5],"Europe/Moscow":[55.7558,37.6178],"Europe/Simferopol":[44.95,34.1],"Europe/Kirov":[58.6,49.65],"Europe/Volgograd":[48.7333,44.4167],"Europe/Astrakhan":[46.35,48.05],"Europe/Saratov":[51.5667,46.0333],"Europe/Ulyanovsk":[54.3333,48.4],"Europe/Samara":[53.2,50.15],"Asia/Yekaterinburg":[56.85,60.6],"Asia/Omsk":[55.0,73.4],"Asia/Novosibirsk":[55.0333,82.9167],"Asia/Barnaul":[53.3667,83.75],"Asia/Tomsk":[56.5,84.9667],"Asia/Novokuznetsk":[53.75,87.1167],"Asia/Krasnoyarsk":[56.0167,92.8333],"Asia/Irkutsk":[52.2667,104.3333],"Asia/Chita":[52.05,113.4667],"Asia/Yakutsk":[62.0,129.6667],"Asia/Khandyga":[62.6564,135.5539],"Asia/Vladivostok":[43.1667,131.9333],"Asia/Ust-Nera":[64.5603,143.2267],"Asia/Magadan":[59.5667,150.8],"Asia/Sakhalin":[46.9667,142.7],"Asia/Srednekolymsk":[67.4667,153.7167],"Asia/Kamchatka":[53.0167,158.65],"Asia/Anadyr":[64.75,177.4833],"Asia/Riyadh":[24.6333,46.7167],"Pacific/Guadalcanal":[-9.5333,160.2],"Africa/Khartoum":[15.6,32.5333],"Asia/Singapore":[1.2833,103.85],"America/Paramaribo":[5.8333,-55.1667],"Africa/Juba":[4.85,31.6167],"Africa/Sao_Tome":[0.3333,6.7333],"America/El_Salvador":[13.7,-89.2],"Asia/Damascus":[33.5,36.3],"America/Grand_Turk":[21.4667,-71.1333],"Africa/Ndjamena":[12.1167,15.05],"Asia/Bangkok":[13.75,100.5167],"Asia/Dushanbe":[38.5833,68.8],"Pacific/Fakaofo":[-9.3667,-171.2333],"Asia/Dili":[-8.55,125.5833],"Asia/Ashgabat":[37.95,58.3833],"Africa/Tunis":[36.8,10.1833],"Pacific/Tongatapu":[-21.1333,-175.2],"Europe/Istanbul":[41.0167,28.9667],"Asia/Taipei":[25.05,121.5],"Europe/Kyiv":[50.4333,30.5167],"America/New_York":[40.7142,-74.0064],"America/Detroit":[42.3314,-83.0458],"America/Kentucky/Louisville":[38.2542,-85.7594],"America/Kentucky/Monticello":[36.8297,-84.8492],"America/Indiana/Indianapolis":[39.7683,-86.1581],"America/Indiana/Vincennes":[38.6772,-87.5286],"America/Indiana/Winamac":[41.0514,-86.6031],"America/Indiana/Marengo":[38.3756,-86.3447],"America/Indiana/Petersburg":[38.4919,-87.2786],"America/Indiana/Vevay":[38.7478,-85.0672],"America/Chicago":[41.85,-87.65],"America/Indiana/Tell_City":[37.9531,-86.7614],"America/Indiana/Knox":[41.2958,-86.625],"America/Menominee":[45.1078,-87.6142],"America/North_Dakota/Center":[47.1164,-101.2992],"America/North_Dakota/New_Salem":[46.845,-101.4108],"America/North_Dakota/Beulah":[47.2642,-101.7778],"America/Denver":[39.7392,-104.9842],"America/Boise":[43.6136,-116.2025],"America/Phoenix":[33.4483,-112.0733],"America/Los_Angeles":[34.0522,-118.2428],"America/Anchorage":[61.2181,-149.9003],"America/Juneau":[58.3019,-134.4197],"America/Sitka":[57.1764,-135.3019],"America/Metlakatla":[55.1269,-131.5764],"America/Yakutat":[59.5469,-139.7272],"America/Nome":[64.5011,-165.4064],"America/Adak":[51.88,-176.6581],"Pacific/Honolulu":[21.3069,-157.8583],"America/Montevideo":[-34.9092,-56.2125],"Asia/Samarkand":[39.6667,66.8],"Asia/Tashkent":[41.3333,69.3],"America/Caracas":[10.5,-66.9333],"Asia/Ho_Chi_Minh":[10.75,106.6667],"Pacific/Efate":[-17.6667,168.4167],"Pacific/Apia":[-13.8333,-171.7333],"Africa/Johannesburg":[-26.25,28.0],"America/Antigua":[17.05,-61.8],"America/Anguilla":[18.2,-63.0667],"Africa/Luanda":[-8.8,13.2333],"Antarctica/McMurdo":[-77.8333,166.6],"Antarctica/DumontDUrville":[-66.6667,140.0167],"Antarctica/Syowa":[-69.0061,39.59],"America/Aruba":[12.5,-69.9667],"Europe/Mariehamn":[60.1,19.95],"Europe/Sarajevo":[43.8667,18.4167],"Africa/Ouagadougou":[12.3667,-1.5167],"Asia/Bahrain":[26.3833,50.5833],"Africa/Bujumbura":[-3.3833,29.3667],"Africa/Porto-Novo":[6.4833,2.6167],"America/St_Barthelemy":[17.8833,-62.85],"Asia/Brunei":[4.9333,114.9167],"America/Kralendijk":[12.1508,-68.2767],"America/Nassau":[25.0833,-77.35],"Africa/Gaborone":[-24.65,25.9167],"America/Blanc-Sablon":[51.4167,-57.1167],"America/Atikokan":[48.7586,-91.6217],"America/Creston":[49.1,-116.5167],"Indian/Cocos":[-12.1667,96.9167],"Africa/Kinshasa":[-4.3,15.3],"Africa/Lubumbashi":[-11.6667,27.4667],"Africa/Bangui":[4.3667,18.5833],"Africa/Brazzaville":[-4.2667,15.2833],"Africa/Douala":[4.05,9.7],"America/Curacao":[12.1833,-69.0],"Indian/Christmas":[-10.4167,105.7167],"Europe/Busingen":[47.7,8.6833],"Africa/Djibouti":[11.6,43.15],"Europe/Copenhagen":[55.6667,12.5833],"America/Dominica":[15.3,-61.4],"Africa/Asmara":[15.3333,38.8833],"Africa/Addis_Ababa":[9.0333,38.7],"Pacific/Chuuk":[7.4167,151.7833],"Pacific/Pohnpei":[6.9667,158.2167],"Africa/Libreville":[0.3833,9.45],"America/Grenada":[12.05,-61.75],"Europe/Guernsey":[49.4547,-2.5361],"Africa/Accra":[5.55,-0.2167],"Africa/Banjul":[13.4667,-16.65],"Africa/Conakry":[9.5167,-13.7167],"America/Guadeloupe":[16.2333,-61.5333],"Africa/Malabo":[3.75,8.7833],"Europe/Zagreb":[45.8,15.9667],"Europe/Isle_of_Man":[54.15,-4.4667],"Atlantic/Reykjavik":[64.15,-21.85],"Europe/Jersey":[49.1836,-2.1067],"Asia/Phnom_Penh":[11.55,104.9167],"Indian/Comoro":[-11.6833,43.2667],"America/St_Kitts":[17.3,-62.7167],"Asia/Kuwait":[29.3333,47.9833],"America/Cayman":[19.3,-81.3833],"Asia/Vientiane":[17.9667,102.6],"America/St_Lucia":[14.0167,-61.0],"Europe/Vaduz":[47.15,9.5167],"Africa/Maseru":[-29.4667,27.5],"Europe/Luxembourg":[49.6,6.15],"Europe/Monaco":[43.7,7.3833],"Europe/Podgorica":[42.4333,19.2667],"America/Marigot":[18.0667,-63.0833],"Indian/Antananarivo":[-18.9167,47.5167],"Pacific/Majuro":[7.15,171.2],"Europe/Skopje":[41.9833,21.4333],"Africa/Bamako":[12.65,-8.0],"Pacific/Saipan":[15.2,145.75],"Africa/Nouakchott":[18.1,-15.95],"America/Montserrat":[16.7167,-62.2167],"Africa/Blantyre":[-15.7833,35.0],"Asia/Kuala_Lumpur":[3.1667,101.7],"Africa/Niamey":[13.5167,2.1167],"Europe/Amsterdam":[52.3667,4.9],"Europe/Oslo":[59.9167,10.75],"Asia/Muscat":[23.6,58.5833],"Indian/Reunion":[-20.8667,55.4667],"Africa/Kigali":[-1.95,30.0667],"Indian/Mahe":[-4.6667,55.4667],"Europe/Stockholm":[59.3333,18.05],"Atlantic/St_Helena":[-15.9167,-5.7],"Europe/Ljubljana":[46.05,14.5167],"Arctic/Longyearbyen":[78.0,16.0],"Europe/Bratislava":[48.15,17.1167],"Africa/Freetown":[8.5,-13.25],"Europe/San_Marino":[43.9167,12.4667],"Africa/Dakar":[14.6667,-17.4333],"Africa/Mogadishu":[2.0667,45.3667],"America/Lower_Princes":[18.0514,-63.0472],"Africa/Mbabane":[-26.3,31.1],"Indian/Kerguelen":[-49.3528,70.2175],"Africa/Lome":[6.1333,1.2167],"America/Port_of_Spain":[10.65,-61.5167],"Pacific/Funafuti":[-8.5167,179.2167],"Africa/Dar_es_Salaam":[-6.8,39.2833],"Africa/Kampala":[0.3167,32.4167],"Pacific/Midway":[28.2167,-177.3667],"Pacific/Wake":[19.2833,166.6167],"Europe/Vatican":[41.9022,12.4531],"America/St_Vincent":[13.15,-61.2333],"America/Tortola":[18.45,-64.6167],"America/St_Thomas":[18.35,-64.9333],"Pacific/Wallis":[-13.3,-176.1667],"Asia/Aden":[12.75,45.2],"Indian/Mayotte":[-12.7833,45.2333],"Africa/Lusaka":[-15.4167,28.2833],"Africa/Harare":[-17.8333,31.05],"UTC":[0,0],"Etc/UTC":[0,0],"Etc/GMT":[0,0],"GMT":[51.4779,0],"US/Eastern":[40.7142,-74.0064],"US/Central":[41.85,-87.65],"US/Mountain":[39.7392,-104.9842],"US/Pacific":[34.0522,-118.2428],"Japan":[35.6544,139.7447],"GB":[51.5083,-0.1253]});
window.__SAKURA_PERF_PROFILE__ = (() => {
  ...
  const pixels = Math.max(1, innerWidth * innerHeight * (devicePixelRatio || 1));
  const veryConstrained = saveData || memory <= 2 || cores <= 2 || (mobile && pixels > 2600000);
  const constrained = veryConstrained || memory <= 4 || cores <= 4 || mobile;
  return Object.freeze({
    constrained, veryConstrained, saveData, reduced, mobile,
    // ECO is the default. The expensive canvas is intentionally rendered below
    // CSS resolution while the browser UI still scrolls/interacts at native FPS.
    ecoDpr: veryConstrained ? .46 : constrained ? .62 : .78,
    ecoFps: veryConstrained ? 14 : constrained ? 18 : 22,
    worldDpr: veryConstrained ? .32 : constrained ? .42 : .58,
    worldFps: veryConstrained ? 16 : constrained ? 20 : 24,
    threeDpr: veryConstrained ? .38 : constrained ? .52 : .72,
    threeFps: veryConstrained ? 10 : constrained ? 15 : 20,
    detail: veryConstrained ? .20 : constrained ? .32 : .58
  });
})();
document.documentElement.classList.toggle('sakura-constrained',Boolean(window.__SAKURA_PERF_PROFILE__?.constrained));
document.documentElement.classList.toggle('sakura-very-constrained',Boolean(window.__SAKURA_PERF_PROFILE__?.veryConstrained));
function __sakuraApproxCoordsForZone(zone) {
  const direct = window.__SAKURA_TZ_COORDS__[zone];
  if (direct) return {lat:direct[0], lng:direct[1], precise:false, zone};
  const offsetHours = -new Date().getTimezoneOffset()/60;
  const locale = (navigator.language || '').toUpperCase();
  const south = /-(ZA|AU|NZ|AR|CL|BR|UY|PY|BO|PE)$/.test(locale);
  return {lat:south?-30:35, lng:Math.max(-179,Math.min(179,offsetHours*15)), precise:false, zone};
}

(() => {
  'use strict';

  const sakuraIdle=(task,timeout=600)=>{
    if('requestIdleCallback' in window) return requestIdleCallback(task,{timeout});
    return setTimeout(task,Math.min(timeout,180));
  };

  // three.min.js is the largest static dependency. Load it only when the intro
  // or a visible 3D lab actually needs it. Phones that never open Robot Lab do
  // not download or parse Three.js at all.
  ...
  function ensureThreeLoaded(){
    ...
    threeLoadPromise=new Promise((resolve,reject)=>{
      ...
      script.src='three.min.js';script.async=true;script.dataset.sakuraThree='1';
      script.onload=()=>window.THREE?resolve(window.THREE):reject(new Error('Three.js loaded without THREE'));
  ...
  const state = {
    ...
    theme: localStorage.getItem('sd-theme') || 'sakura',
    themeMode: localStorage.getItem('sd-theme-mode') || 'manual',
    resumeLastRoute: localStorage.getItem('sd-resume-route') === '1',
    language: localStorage.getItem('sd-language') || 'en',
    focusMode: localStorage.getItem('sd-focus-mode') === '1',
    density: localStorage.getItem('sd-density') || 'balanced',
    glow: localStorage.getItem('sd-glow') || 'signature',
    surface: localStorage.getItem('sd-surface') || 'glass',
    focusRing: localStorage.getItem('sd-focus-ring') || 'standard',
    linkClarity: localStorage.getItem('sd-link-clarity') || 'standard',
    textComfort: localStorage.getItem('sd-text-comfort') || 'standard',
    signalLens: localStorage.getItem('sd-signal-lens') || 'balanced',
    readingProgress: localStorage.getItem('sd-reading-progress') === '1',
    shortcutHints: localStorage.getItem('sd-shortcut-hints') !== '0',
    edgeSignal: localStorage.getItem('sd-edge-signal') || 'off',
    sceneResolution: localStorage.getItem('sd-scene-resolution') || 'auto',
    fpsPreference: localStorage.getItem('sd-fps-preference') || 'auto',
    timeFormat: localStorage.getItem('sd-time-format') || '12',
    temperatureEnabled: localStorage.getItem('sd-temperature-enabled') !== '0',
    temperatureUnit: localStorage.getItem('sd-temperature-unit') || 'F',
    temperatureC: null,
  ...
  ['contextmenu','dragstart','selectstart'].forEach(type=>document.addEventListener(type,event=>{if(event.target?.closest?.('.photo-protect'))event.preventDefault()}));
  const toast = $('#toast');
  let toastTimer = 0;
  ...
  function formatTime(date) {
    return new Intl.DateTimeFormat(undefined, {timeZone:state.timeZone,hour:'numeric', minute:'2-digit',hour12:state.timeFormat!=='24'}).format(date);
  }
  function formatDate(date) {
    return new Intl.DateTimeFormat(undefined, {timeZone:state.timeZone,weekday:'long', month:'long', day:'numeric', year:'numeric'}).format(date);
  }
  const THEME_META=[["sakura","Sakura Original","Cherry neon",["#9cff52","#55e8ff","#ff78b8"],"Signature"],["neon-tokyo","Neon Tokyo","Cyber city",["#00efff","#ff3b9d","#c6ff35"],"Signature"],["cyber-sakura","Cyber Sakura","Cherry + ultraviolet",["#a8ff4d","#7af7ff","#ff5cbd"],"Signature"],["kyoto-lantern","Kyoto Lantern","Warm lantern night",["#ffd166","#74e8d5","#ff7f8f"],"Signature"],["shibuya-pulse","Shibuya Pulse","Electric magenta",["#b6ff39","#00e8ff","#ff2f92"],"Signature"],["aurora-grid","Aurora Grid","Lime + violet",["#aaff62","#59f5d0","#b06cff"],"Signature"],["midnight-circuit","Midnight Circuit","Engineering blue",["#72f6ff","#7295ff","#a977ff"],"City"],["tokyo-night","Tokyo Night","Indigo + cyan",["#7aa2f7","#7dcfff","#bb9af7"],"City"],["seoul-neon","Seoul Neon","Cobalt + rose",["#9cff57","#5ee8ff","#ff6fae"],"City"],["taipei-circuit","Taipei Circuit","Teal + orchid",["#8cffc8","#4fe1ff","#c07cff"],"City"],["singapore-night","Singapore Night","Emerald skyline",["#79f29a","#66d9ff","#ff80c8"],"City"],["nasa-deep-space","NASA Deep Space","Spacecraft navy",["#8cff66","#66c8ff","#d58cff"],"City"],["new-york-night","New York Night","Taxi gold + midnight blue",["#ffd166","#5cc8ff","#ff5d8f"],"City"],["san-francisco-fog","San Francisco Fog","Bay blue + bridge orange",["#ff8a5b","#7ad7ff","#f4c96b"],"City"],["london-electric","London Electric","Roundel red + electric blue",["#ff4d5e","#6ed7ff","#f4e8d0"],"City"],["paris-midnight","Paris Midnight","Champagne + midnight rose",["#f0d28c","#8cc8ff","#ff8fb7"],"City"],["berlin-techno","Berlin Techno","Concrete + acid signal",["#d6ff00","#00e5ff","#ff3d81"],"City"],["dubai-skyline","Dubai Skyline","Gold + glass turquoise",["#e9c46a","#49d6ff","#ff7ab8"],"City"],["mumbai-monsoon","Mumbai Monsoon","Saffron + rain blue",["#ffb703","#55d8ff","#ff5d8f"],"City"],["cape-town-dusk","Cape Town Dusk","Ocean blue + sunset coral",["#80d99a","#60cfff","#ff8b6a"],"City"],["athens-aegean","Athens Aegean","Aegean blue + marble white",["#f5f3e8","#49c8ff","#7cb8ff"],"City"],["hong-kong-harbor","Hong Kong Harbor","Harbor cyan + neon red",["#ff4d6d","#00e5ff","#ff7bd5"],"City"],["osaka-electric","Osaka Electric","Electric orange + cyan",["#ff9f43","#4de8ff","#ff5db1"],"City"],["mexico-city-noche","Mexico City Noche","Marigold + deep green",["#ffd166","#55d6c2","#ff5c8a"],"City"],["purdue-gold","Purdue Black & Gold","Boilermaker signal",["#cfb991","#f2d78c","#8bc8ff"],"Professional"],["graphite-pro","Graphite Pro","Neutral engineering",["#a6e3a1","#7dcfff","#c7a0ff"],"Professional"],["cobalt-robotics","Cobalt Robotics","Lab cobalt",["#9cff68","#67d7ff","#8aa4ff"],"Professional"],["arctic-lab","Arctic Lab","Cool technical",["#a9f59a","#8cd8ff","#d0a5ff"],"Professional"],["silicon-valley","Silicon Valley","Clean product",["#84e39c","#58b9ff","#c183ff"],"Professional"],["lunar-silver","Lunar Silver","Silver + blue",["#d9f0ff","#7ac7ff","#b9a2ff"],"Professional"],["github-dark","GitHub Dark","Clean graphite",["#3fb950","#58a6ff","#d2a8ff"],"Editor"],["one-dark","One Dark","Modern editor",["#98c379","#61afef","#c678dd"],"Editor"],["dracula","Dracula","Violet + pink",["#50fa7b","#8be9fd","#ff79c6"],"Editor"],["night-owl","Night Owl","Deep navy",["#addb67","#82aaff","#c792ea"],"Editor"],["catppuccin","Catppuccin Mocha","Soft premium",["#a6e3a1","#89dceb","#f5c2e7"],"Editor"],["synthwave","SynthWave","Electric retro",["#72f1b8","#36f9f6","#ff7edb"],"Editor"],["horizon","Horizon","Warm dusk",["#e4a88a","#25b0bc","#e95678"],"Editor"],["nord","Nord Aurora","Arctic calm",["#a3be8c","#88c0d0","#b48ead"],"Editor"],["solarized","Solarized Dark","Academic calm",["#859900","#2aa198","#d33682"],"Editor"],["monokai","Monokai","Crisp contrast",["#a6e22e","#66d9ef","#f92672"],"Editor"],["emerald-terminal","Emerald Terminal","Green terminal",["#5cff8d","#63d9ff","#d7a1ff"],"Professional"],["signal-contrast","Signal Contrast","High legibility",["#c4ff4d","#71eaff","#ff75c7"],"Professional"],["cherry-blossom","Cherry Blossom","Rose petals + lacquer",["#ff6f91","#ffd0dc","#ff3f75"],"Signature"],["crimson-sakura","Crimson Sakura","Deep red + spring pink",["#ff526f","#ffc2cf","#ff789c"],"Signature"],["sakura-dawn","Sakura Dawn","Peach sunrise + petal pink",["#ff9f7a","#ffd2de","#ff6f9e"],"Signature"],["wisteria-night","Wisteria Night","Violet bloom + moon cyan",["#c69cff","#8ee8ff","#ff9ed8"],"Signature"],["matcha-garden","Matcha Garden","Tea green + warm cream",["#a8d96f","#d8f2c2","#f2c879"],"Signature"],["fuji-dawn","Fuji Dawn","Alpine blue + sunrise rose",["#8fc8ff","#d7e8ff","#ff8ba7"],"Signature"],["maple-ember","Maple Ember","Autumn amber + crimson",["#ffb347","#ffd58a","#ff5f67"],"Signature"],["plum-blossom","Plum Blossom","Plum violet + soft rose",["#d98cff","#ffb5d3","#ff6fae"],"Signature"],["koi-lantern","Koi Lantern","Vermilion + lantern gold",["#ff744d","#ffd36a","#5de0d0"],"Signature"],["indigo-rain","Indigo Rain","Deep indigo + rain cyan",["#8f9cff","#63ddff","#c28cff"],"Signature"],["doraemon-blue","Doraemon Blue","Future blue + red signal",["#29a9e8","#f7fbff","#ef4050"],"Pop Culture"],["nobita-classic","Nobita Classic","Yellow shirt + blue shorts",["#f3d84f","#4b73b9","#ef5a5a"],"Pop Culture"],["shizuka-pink","Shizuka Pink","Soft pink + clean white",["#ef8fba","#ffd8e8","#f56f9f"],"Pop Culture"],["suneo-sky","Suneo Sky","Teal blue + smart green",["#67c9db","#8ed8c1","#d5ad55"],"Pop Culture"],["gian-orange","Gian Orange","Bold orange + warm brown",["#f3923b","#ffd39b","#8a532c"],"Pop Culture"],["dorami-sunshine","Dorami Sunshine","Sunny yellow + ribbon red",["#f7c928","#fff4c7","#ef4a57"],"Pop Culture"]
,["sunrise-glow","Sunrise Glow","Peach horizon + morning gold",["#ffb36b","#ffe2a6","#ff8aa8"],"Signature"],["sunset-ember","Sunset Ember","Coral horizon + amber light",["#ff8a5b","#ffc857","#ff5f87"],"Signature"],["blue-hour-twilight","Blue Hour Twilight","Indigo sky + violet afterglow",["#87a7ff","#79d6ff","#c88cff"],"Signature"],["coral-lagoon","Coral Lagoon","Sunny reef-inspired yellow + aqua",["#ffd84d","#56e6ff","#ff7fa6"],"Signature"],["future-pocket-blue","Future Pocket Blue","Friendly retro-future cobalt + red",["#49b8ff","#f4fbff","#ff5968"],"Signature"],["comet-twilight","Comet Twilight","Celestial blue + magenta dusk",["#79b8ff","#b28dff","#ff83a8"],"Signature"],["moonrise-silver","Moonrise Silver","Silver moon + deep cobalt",["#e6f1ff","#86c7ff","#b59cff"],"Professional"],["rainy-neon","Rainy Neon","Wet asphalt cyan + rose",["#74e8ff","#7f9bff","#ff6aa9"],"City"],["alpine-morning","Alpine Morning","Ice blue + fresh spring green",["#a8e6ff","#b8f59a","#ffd4e2"],"Professional"],["bikini-bottom","Bikini Bottom","SpongeBob-inspired sun yellow + lagoon aqua",["#f8e24d","#45c7e6","#d8904f"],"Pop Culture"],["your-name-twilight","Your Name Twilight","Comet blue + ribbon rose + starlight",["#66a7d7","#e7edf3","#d95f78"],"Pop Culture"],["taki-tokyo","Taki Tokyo","City blue + white shirt + green tie",["#4f78ae","#f3f4ef","#6b8c58"],"Pop Culture"],["mitsuha-itomori","Mitsuha Itomori","Ribbon red + lavender dusk + warm light",["#b84d5c","#7b6d91","#e7c59b"],"Pop Culture"]];
  const THEME_PREVIEWS={"sakura":{"bg":"#050b18","card":"rgba(7,22,52,.92)","text":"#f4f7ff","accent":"#9cff52","cyan":"#55e8ff","pink":"#ff78b8"},"neon-tokyo":{"bg":"#060718","card":"rgba(20,13,52,.94)","text":"#f9f8ff","accent":"#c6ff35","cyan":"#00efff","pink":"#ff3b9d"},"cyber-sakura":{"bg":"#080816","card":"#15183d","text":"#f9f8ff","accent":"#a8ff4d","cyan":"#7af7ff","pink":"#ff5cbd"},"kyoto-lantern":{"bg":"#120b0d","card":"#301923","text":"#fff8ef","accent":"#ffd166","cyan":"#74e8d5","pink":"#ff7f8f"},"shibuya-pulse":{"bg":"#080616","card":"#1e1039","text":"#fbf8ff","accent":"#b6ff39","cyan":"#00e8ff","pink":"#ff2f92"},"aurora-grid":{"bg":"#051016","card":"rgba(8,36,48,.94)","text":"#f5fff9","accent":"#aaff62","cyan":"#59f5d0","pink":"#e879ff"},"midnight-circuit":{"bg":"#040a17","card":"rgba(6,30,58,.94)","text":"#f2f8ff","accent":"#72f6ff","cyan":"#4dc9ff","pink":"#a977ff"},"tokyo-night":{"bg":"#10131f","card":"rgba(27,33,56,.96)","text":"#c0caf5","accent":"#9ece6a","cyan":"#7dcfff","pink":"#f7768e"},"seoul-neon":{"bg":"#06101d","card":"#11263d","text":"#f5fbff","accent":"#9cff57","cyan":"#5ee8ff","pink":"#ff6fae"},"taipei-circuit":{"bg":"#051018","card":"#0e2a35","text":"#f5fffb","accent":"#8cffc8","cyan":"#4fe1ff","pink":"#c07cff"},"singapore-night":{"bg":"#04110d","card":"#0d3026","text":"#f4fff9","accent":"#79f29a","cyan":"#66d9ff","pink":"#ff80c8"},"nasa-deep-space":{"bg":"#020714","card":"#0b1b33","text":"#f4f8ff","accent":"#8cff66","cyan":"#66c8ff","pink":"#d58cff"},"purdue-gold":{"bg":"#0d0b08","card":"#252117","text":"#fffaf0","accent":"#cfb991","cyan":"#f2d78c","pink":"#8bc8ff"},"graphite-pro":{"bg":"#0b0d10","card":"#1c222a","text":"#f6f8fa","accent":"#a6e3a1","cyan":"#7dcfff","pink":"#c7a0ff"},"cobalt-robotics":{"bg":"#06101f","card":"#0e2747","text":"#f6f9ff","accent":"#9cff68","cyan":"#67d7ff","pink":"#8aa4ff"},"arctic-lab":{"bg":"#071116","card":"#16323b","text":"#f5fffe","accent":"#a9f59a","cyan":"#8cd8ff","pink":"#d0a5ff"},"silicon-valley":{"bg":"#07110c","card":"#173025","text":"#f4fff8","accent":"#84e39c","cyan":"#58b9ff","pink":"#c183ff"},"lunar-silver":{"bg":"#090d14","card":"#1d2837","text":"#f8fbff","accent":"#d9f0ff","cyan":"#7ac7ff","pink":"#b9a2ff"},"github-dark":{"bg":"#0d1117","card":"rgba(28,33,40,.98)","text":"#f0f6fc","accent":"#3fb950","cyan":"#58a6ff","pink":"#f778ba"},"one-dark":{"bg":"#21252b","card":"rgba(45,50,59,.98)","text":"#e6e9ef","accent":"#98c379","cyan":"#56b6c2","pink":"#e06c75"},"dracula":{"bg":"#282a36","card":"rgba(47,49,63,.98)","text":"#f8f8f2","accent":"#50fa7b","cyan":"#8be9fd","pink":"#ff79c6"},"night-owl":{"bg":"#011627","card":"rgba(5,33,54,.98)","text":"#d6deeb","accent":"#addb67","cyan":"#7fdbca","pink":"#f78c6c"},"catppuccin":{"bg":"#1e1e2e","card":"rgba(36,36,54,.98)","text":"#cdd6f4","accent":"#a6e3a1","cyan":"#89dceb","pink":"#f5c2e7"},"synthwave":{"bg":"#171520","card":"rgba(41,27,59,.98)","text":"#f8f8ff","accent":"#72f1b8","cyan":"#36f9f6","pink":"#ff7edb"},"horizon":{"bg":"#1c1e26","card":"rgba(38,38,49,.98)","text":"#d5d8da","accent":"#09f7a0","cyan":"#25b0bc","pink":"#e95678"},"nord":{"bg":"#2e3440","card":"rgba(53,60,73,.98)","text":"#eceff4","accent":"#a3be8c","cyan":"#88c0d0","pink":"#d08770"},"solarized":{"bg":"#002b36","card":"rgba(3,54,66,.98)","text":"#eee8d5","accent":"#859900","cyan":"#2aa198","pink":"#d33682"},"monokai":{"bg":"#272822","card":"rgba(47,48,41,.98)","text":"#f8f8f2","accent":"#a6e22e","cyan":"#66d9ef","pink":"#f92672"},"emerald-terminal":{"bg":"#03100a","card":"#0c2d1e","text":"#f0fff6","accent":"#5cff8d","cyan":"#63d9ff","pink":"#d7a1ff"},"signal-contrast":{"bg":"#02040a","card":"#0d1523","text":"#ffffff","accent":"#c4ff4d","cyan":"#71eaff","pink":"#ff75c7"},"sakura-dawn":{"bg":"#160e16","card":"#3b1f31","text":"#fff8fb","accent":"#ff9f7a","cyan":"#ffd2de","pink":"#ff6f9e"},"wisteria-night":{"bg":"#0b0918","card":"#251d45","text":"#faf8ff","accent":"#c69cff","cyan":"#8ee8ff","pink":"#ff9ed8"},"matcha-garden":{"bg":"#08110b","card":"#1b3120","text":"#f8fff5","accent":"#a8d96f","cyan":"#d8f2c2","pink":"#f2c879"},"fuji-dawn":{"bg":"#07101e","card":"#17304a","text":"#f8fbff","accent":"#8fc8ff","cyan":"#d7e8ff","pink":"#ff8ba7"},"maple-ember":{"bg":"#160b08","card":"#3d2118","text":"#fff8f1","accent":"#ffb347","cyan":"#ffd58a","pink":"#ff5f67"},"plum-blossom":{"bg":"#120916","card":"#371c3c","text":"#fff7ff","accent":"#d98cff","cyan":"#ffb5d3","pink":"#ff6fae"},"koi-lantern":{"bg":"#120b08","card":"#3a1e18","text":"#fff9f2","accent":"#ff744d","cyan":"#5de0d0","pink":"#ffd36a"},"indigo-rain":{"bg":"#07091a","card":"#1d2347","text":"#f7f8ff","accent":"#8f9cff","cyan":"#63ddff","pink":"#c28cff"}};
  const SAKURA_THEMES=new Set(THEME_META.map(theme=>theme[0]));
  function applyTheme(theme,{save=true,fromSky=false}={}){
    const next=SAKURA_THEMES.has(theme)?theme:'sakura';state.theme=next;document.documentElement.dataset.theme=next;
    const metaInfo=THEME_META.find(x=>x[0]===next);const preview=themePaletteFromCSS(next,metaInfo?.[3]);const metaTheme=document.querySelector('meta[name="theme-color"]');if(metaTheme&&preview?.bg)metaTheme.setAttribute('content',preview.bg);
    if(save){try{localStorage.setItem('sd-theme',next)}catch{};if(!fromSky){state.themeMode='manual';try{localStorage.setItem('sd-theme-mode','manual')}catch{};document.documentElement.classList.remove('sky-sync-active');$$('[data-theme-mode]').forEach(b=>{const active=b.dataset.themeMode==='manual';b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))})}}
    const select=$('#setting-theme');if(select&&select.value!==next)select.value=next;
    $$('[data-theme-choice]').forEach(button=>{const active=button.dataset.themeChoice===next;button.classList.toggle('is-active',active);button.setAttribute('aria-pressed',String(active))});
  }
  function skyThemeForSnapshot(snapshot){
    if(!snapshot)return 'sakura';
    const now=Number(snapshot.now),sunrise=Number(snapshot.sunrise),sunset=Number(snapshot.sunset),sunAlt=Number(snapshot.sunAlt);
    if(Number.isFinite(sunrise)&&Number.isFinite(now)&&now>=sunrise-45*60*1000&&now<=sunrise+75*60*1000)return 'sunrise-glow';
    if(Number.isFinite(sunset)&&Number.isFinite(now)&&now>=sunset-75*60*1000&&now<=sunset+35*60*1000)return 'sunset-ember';
    if(Number.isFinite(sunAlt)&&sunAlt<=-10)return 'midnight-circuit';
    if(Number.isFinite(sunAlt)&&sunAlt<4)return 'blue-hour-twilight';
    return 'sakura';
  }
  function skyThemeForNow(){const sky=state.sky;if(!sky?.times||!sky.now)return 'sakura';return skyThemeForSnapshot({now:sky.now.getTime(),sunrise:sky.times.sunrise?.getTime?.(),sunset:sky.times.sunset?.getTime?.(),sunAlt:sky.sunAlt})}
  function syncThemeToSnapshot(snapshot){if(state.themeMode!=='sky')return;const next=skyThemeForSnapshot(snapshot);if(next!==state.theme)applyTheme(next,{save:false,fromSky:true})}
  function syncThemeToSky(){if(state.themeMode!=='sky')return;const next=skyThemeForNow();if(next!==state.theme)applyTheme(next,{save:false,fromSky:true})}
  function setThemeMode(value,{silent=false}={}){const next=value==='sky'?'sky':'manual';state.themeMode=next;try{localStorage.setItem('sd-theme-mode',next)}catch{};document.documentElement.classList.toggle('sky-sync-active',next==='sky');$$('[data-theme-mode]').forEach(b=>{const active=b.dataset.themeMode===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});if(next==='sky')syncThemeToSky();else{const manual=localStorage.getItem('sd-theme')||'sakura';applyTheme(manual,{save:false,fromSky:true})}if(!silent)showToast(next==='sky'?'Sky Sync enabled — only the interface palette follows the same accurate local sky used by the live world.':'Manual palette restored — sky timing, temperature, sunrise, sunset, and the live world remain unchanged.')}
  addEventListener('sakura:world-clock',event=>{if(state.themeMode==='sky'&&event.detail)syncThemeToSnapshot(event.detail)});
  function randomizeTheme(){
    let pool=THEME_META.filter(([id])=>id!==state.theme);
    if(!pool.length)pool=THEME_META.slice();
    const choice=pool[Math.floor(Math.random()*pool.length)];
    if(!choice)return;
    applyTheme(choice[0]);
    renderThemeGallery($('#quick-theme-grid'),activeThemeFilter==='Random'?'All':activeThemeFilter);
    showToast(`Random theme: ${choice[1]}. Sky Sync switched to Manual so your surprise choice stays selected.`);
  }
  function themePaletteFromCSS(id,colors=['#9cff52','#55e8ff','#ff78b8']){
    const fallback=THEME_PREVIEWS[id]||{bg:'#050b18',card:'#081734',text:'#f4f7ff',accent:colors[0],cyan:colors[1],pink:colors[2]};
    ...
    try{
      for(const sheet of [...document.styleSheets]){
        ...
        for(const rule of [...rules]){
          ...
          const selectors=rule.selectorText.split(',').map(x=>x.trim());if(!selectors.includes(selector))continue;
          const get=(name,def)=>rule.style.getPropertyValue(name).trim()||def;
          return{bg:get('--bg',fallback.bg),card:get('--theme-card-strong',get('--panel-2',fallback.card)),text:get('--text',fallback.text),accent:get('--lime',fallback.accent),cyan:get('--cyan',fallback.cyan),pink:get('--pink',fallback.pink)};
        }
      }
    }catch{}
    return fallback;
  }
  function renderThemeGallery(target,filter='All'){
    if(!target)return;
    const list=THEME_META.filter(([, , , ,category])=>filter==='All'||category===filter);
    target.innerHTML=list.map(([id,name,description,colors,category])=>{const p=themePaletteFromCSS(id,colors);return `<button class="theme-choice" data-theme-choice="${id}" data-theme-category="${category}" type="button" role="listitem" aria-label="${name}: ${description}" aria-pressed="${id===state.theme}"><span class="theme-preview" aria-hidden="true" style="--preview-bg:${p.bg};--preview-card:${p.card};--preview-text:${p.text};--preview-accent:${p.accent};--preview-cyan:${p.cyan};--preview-pink:${p.pink}"><i class="theme-preview-accent"></i><i class="theme-preview-cyan"></i><i class="theme-preview-pink"></i></span><span><strong>${name}</strong><small>${description}</small></span></button>`}).join('');
    $$('[data-theme-choice]',target).forEach(button=>button.addEventListener('click',()=>{applyTheme(button.dataset.themeChoice);showToast(`Theme changed to ${THEME_META.find(x=>x[0]===button.dataset.themeChoice)?.[1]||'Sakura Signal'}. Preview and applied palette are synchronized.`)}));
  }
  ...
  function nearestIanaTimeZone(lat,lng){
    const table=window.__SAKURA_TZ_COORDS__||{};let best='',bestScore=Infinity;
    const cosLat=Math.max(.2,Math.cos(lat*Math.PI/180));
    for(const [zone,coords] of Object.entries(table)){
      if(!Array.isArray(coords)||coords.length<2||/^(Etc\/|US\/|GMT$|UTC$)/.test(zone))continue;
      const dLat=coords[0]-lat;let dLng=Math.abs(coords[1]-lng);dLng=Math.min(dLng,360-dLng);
      const score=dLat*dLat+(dLng*cosLat)*(dLng*cosLat);
  ...
  function inferLocation(){
    try{
      const saved=JSON.parse(sessionStorage.getItem('sd-sky-coords-v3')||'null');
      if(saved&&Number.isFinite(saved.lat)&&Number.isFinite(saved.lng)){
        state.coords={lat:saved.lat,lng:saved.lng,precise:true};
        state.timeZone=sessionStorage.getItem('sd-sky-zone-v3')||nearestIanaTimeZone(saved.lat,saved.lng);
        state.locationSource='precise';state.placeLabel='Precise local sky';updateSky(true);return;
      }
    }catch{}
    const zone=Intl.DateTimeFormat().resolvedOptions().timeZone||'UTC';
    const c=__sakuraApproxCoordsForZone(zone);
    state.timeZone=zone;state.coords={lat:c.lat,lng:c.lng,precise:false};
    state.locationSource='timezone';state.placeLabel='Private local sky estimate';updateSky(true);
  }
  function requestPreciseLocation(showFeedback=true){
    if(!navigator.geolocation){if(showFeedback)showToast('Precise sky sync is not available in this browser.');return}
    if(showFeedback)showToast('Requesting private sky-sync permission…');
    navigator.geolocation.getCurrentPosition(position=>{
      const lat=position.coords.latitude,lng=position.coords.longitude,zone=nearestIanaTimeZone(lat,lng);
      state.coords={lat,lng,precise:true};state.timeZone=zone;state.placeLabel='Precise local sky';state.locationSource='precise';
      sessionStorage.setItem('sd-sky-coords-v3',JSON.stringify({lat,lng,precise:true}));
      sessionStorage.setItem('sd-sky-zone-v3',zone);
      updateSky(true);window.dispatchEvent(new CustomEvent('sakura:sky-location',{detail:{lat,lng,timeZone:zone}}));refreshLocalTemperature({force:true});
      if(showFeedback)showToast('Sunrise, sunset, sun and moon are synced to this location. Coordinates stay in this browser session.');
    },error=>{if(showFeedback)showToast(error.code===1?'Location permission was not granted; using a private time-zone estimate.':'Precise sky sync was unavailable; using a private time-zone estimate.');updateSky(true)},
  ...
  function updateSky(force=false){
    ...
    if(state.locationSource!=='precise'&&detectedZone!==state.timeZone){const c=__sakuraApproxCoordsForZone(detectedZone);state.timeZone=detectedZone;state.coords={lat:c.lat,lng:c.lng,precise:false};state.placeLabel='Private local sky estimate';force=true}
    ...
    state.sky={now,sun,moon,times,illumination,sunAlt,moonAlt};applyPalette(phase);applySceneWeights(sunAlt);syncThemeToSky();
  ...
  async function runIntro(force=false){
    ...
    if(new URLSearchParams(location.search).has('preview')||(!force&&!state.alwaysIntro&&(prefersReducedMotion||window.__SAKURA_PERF_PROFILE__?.veryConstrained||sessionStorage.getItem('sd-intro-seen')==='1'))){finishIntro(true);return}
    if(!supportsWebGL()){ $('#intro-canvas').hidden=true;$('#intro-fallback').hidden=false;setTimeout(()=>finishIntro(),3400);return }
    if(typeof THREE==='undefined'){
      $('#intro-canvas').hidden=true;$('#intro-fallback').hidden=false;
      try{await ensureThreeLoaded()}catch{setTimeout(()=>finishIntro(),3400);return}
      if(introDone)return;
    }
    ...
    const introPerf=window.__SAKURA_PERF_PROFILE__||{constrained:false,veryConstrained:false,threeDpr:1.12};introRenderer=new THREE.WebGLRenderer({canvas,antialias:!introPerf.constrained,alpha:false,powerPreference:'high-performance'});introRenderer.setPixelRatio(Math.min(devicePixelRatio,introPerf.constrained?Math.min(.86,introPerf.threeDpr):1.25));introRenderer.setSize(innerWidth,innerHeight,false);
    ...
    const sparks=[];for(let i=0;i<(introPerf.constrained?22:38);i++){const sp=new THREE.Mesh(new THREE.SphereGeometry(.025+Math.random()*.04,8,8),new THREE.MeshBasicMaterial({color:i%3?0xffb347:0x69e8ff,transparent:true,opacity:0}));sp.position.copy(impactRing.position);sp.userData.angle=Math.random()*Math.PI*2;sp.userData.speed=1+Math.random()*3;sparks.push(sp);scene.add(sp)}
    const motes=[];for(let i=0;i<(introPerf.constrained?28:54);i++){const mote=new THREE.Mesh(new THREE.SphereGeometry(.012+Math.random()*.026,7,7),new THREE.MeshBasicMaterial({color:i%4===0?0x66eaff:0xffc46b,transparent:true,opacity:.18+Math.random()*.42}));mote.position.set((Math.random()-.5)*18,-.2+Math.random()*8,-4+Math.random()*9);mote.userData={baseY:mote.position.y,speed:.25+Math.random()*.55,phase:Math.random()*Math.PI*2};motes.push(mote);scene.add(mote)}
    ...
    function frame(now){
      if(introDone||!introRenderer)return;introFrame=requestAnimationFrame(frame);const t=((now-start)/1000)*1.45;
  ...
  /* -------------------------------------------------------------------
     ...
     ------------------------------------------------------------------- */
  let homeRobot=null,labRobot=null,homeRobotQueued=false;
  function ensureHomeRobot(){
    if(homeRobot||homeRobotQueued)return;
    homeRobotQueued=true;
    sakuraIdle(async()=>{
      homeRobotQueued=false;
      if(homeRobot||document.body.dataset.route!=='home')return;
      // The homepage robot is decorative on small/weak devices; defer it until
      // hardware and viewport can afford it. Robot Lab still loads on demand.
      const perf=window.__SAKURA_PERF_PROFILE__||{};
      if(perf.veryConstrained||matchMedia('(max-width:620px)').matches)return;
      try{await ensureThreeLoaded();if(document.body.dataset.route==='home'&&!homeRobot)homeRobot=setupThreeScene($('#home-robot-canvas'),{model:'humanoid',home:true})}catch{}
    },700);
  }
  function routeTo(route,anchor=''){
    route=validRoutes.has(route)?route:'home';state.route=route;document.body.dataset.route=route;if(state.resumeLastRoute)try{localStorage.setItem('sd-last-route',route)}catch{};location.hash=`#/${route}${anchor?`/${anchor}`:''}`;$$('.view').forEach(v=>v.classList.toggle('is-active',v.dataset.view===route));$$('[data-route]').forEach(b=>b.classList.toggle('is-active',b.dataset.route===route));$$('.mobile-dock [data-route]').forEach(b=>b.classList.toggle('is-active',b.dataset.route===route));const sideMore=$('#side-more');if(sideMore&&['why','technology','proof','ai','role-match'].includes(route))sideMore.open=true;$('#mobile-sheet').hidden=true;$('#mobile-menu').setAttribute('aria-expanded','false');window.scrollTo(0,0);playTone('select');if(route==='robotics'&&!labRobot)ensureThreeLoaded().then(()=>{if(document.body.dataset.route==='robotics'&&!labRobot)labRobot=setupThreeScene($('#lab-robot-canvas'),{model:'arm'})}).catch(()=>{});if(route==='home')ensureHomeRobot();if(state.language&&state.language!=='en')setTimeout(()=>translateVisibleRoute(state.language,{silent:true}),120);if(anchor)setTimeout(()=>document.getElementById(anchor)?.scrollIntoView({behavior:state.reducedMotion?'auto':'smooth',block:'center'}),160)
  }
  ...
  const SEARCH_INDEX = [
    ...
    ['Technology connected to projects','technology','','Python JavaScript TypeScript SQL PostgreSQL AWS EC2 cloud Supabase RPC Row Level Security FANUC YAMAHA NX Teamcenter SOLIDWORKS Onshape RoadRunner Linux YOLO SAM CLIP OpenCV PyTorch TensorFlow Keras scikit learn WhisperX Silero VAD ROS OAK LangGraph Redis FastAPI Next.js GitHub'],
  ...
  const PROJECT_DETAILS = {
    industrial:{title:'FANUC + YAMAHA Industrial Robotics',body:`<p>What makes this work useful to a robotics team is that Suyash did not stop at a motion program. He worked across the boundary between <strong>geometry, tooling, sensors, robot state, and safe execution</strong>—the place where otherwise-correct code often fails on real hardware.</p><h3>What he actually owned</h3><ul><li>For the FANUC LR Mate 200i, translated workcell measurements into a hook-shaped end-effector in Siemens NX, moved that design through 3D printing and physical fit-up, then programmed and tested the autonomous lock-transfer sequence.</li><li>For the YAMAHA YK600XGL SCARA, built a sensor-aware workflow that could handle unknown chip-stack heights instead of assuming a perfect starting condition.</li><li>Combined position registers, proximity sensing, suction, I/O, buttons, indicator lights, guarded-cell procedures, and iterative path/timing changes to place 15 chips into a precise 5×3 grid.</li></ul><h3>Why a company should care</h3><p>Suyash is most valuable when the problem is not neatly divided into “mechanical” or “software.” He is comfortable tracing a failure from CAD geometry to end-effector fit, from a sensor transition to a register value, or from a motion path to repeatability and safety. That systems mindset is the foundation he is extending into ROS 2, simulation, controls, and more advanced autonomous robotics.</p>`},
    autonomy:{title:'Multimodal Vehicle-Safety Research',body:`<p>Suyash approached perception from a reliability question: <strong>what useful signal remains when the camera is uncertain?</strong> Instead of treating another sensor as a buzzword, he built a research prototype that asks audio and vision to cover different failure modes.</p><h3>Engineering approach</h3><ul><li>Combined YOLO-based visual perception with AudioSet-focused transformer classification for vehicle-relevant sound events.</li><li>Used waveform behavior to estimate coarse proximity categories, then treated audio as complementary evidence rather than claiming it replaces radar or LiDAR.</li><li>Documented the prototype’s reported improvement under its own test conditions and kept real-world validation clearly separated from research-stage evidence.</li></ul><h3>Why it stands out</h3><p>The project shows how Suyash thinks about autonomy: not as a single model with a confidence score, but as a system that should recognize uncertainty, preserve redundancy, and protect the people depending on it. He is the sole inventor on a <strong>provisional patent filed</strong> for the work and has presented it at the Polygence National Conference and Purdue Shreve Tank.</p>`},
    aimm:{title:'RoBoat — Computer Vision Leadership',body:`<p>On RoBoat, Suyash works where perception stops being a notebook exercise and starts affecting a physical autonomous platform. As Vice President and Computer Vision Lead for a nearly 30-member team, he has to think about <strong>data quality, camera behavior, model output, controls needs, and whether teammates can reproduce the pipeline</strong>.</p><h3>What that looks like</h3><ul><li>Develops and reviews buoy-detection work with Python, YOLO, Roboflow, ROS, and OAK cameras.</li><li>Works through thousands of images and model outputs to separate a weak model from a weak dataset, lighting problem, reflection issue, or integration problem.</li><li>Coordinates perception expectations with controls and mentors teammates so knowledge does not remain trapped with one person.</li></ul><h3>What he brings to an autonomy team</h3><p>He naturally moves between implementation and leadership: debugging the perception stack, explaining what the model can and cannot be trusted to do, and helping the team turn detections into a usable behavior. His active ROS 2/SLAM learning is aimed at deepening exactly that perception-to-autonomy connection.</p>`},
    lifeos:{title:'LifeOS — Six-Agent Decision Council',body:`<p>LifeOS was not designed as six chatbots sitting next to each other. The interesting problem was <strong>coordination</strong>: letting specialized agents recall context, detect competing goals, debate tradeoffs, and return one coherent proposal.</p><h3>Architecture and ownership</h3><ul><li>Six specialist agents for Career, Finance, Learning, Calendar, Health, and Accountability, orchestrated with LangGraph.</li><li>Redis Pub/Sub, Streams, and vector memory for state and recall; W&B Weave for tracing; FastAPI plus Next.js/TypeScript and CopilotKit for the application layer.</li><li>When a teammate withdrew with only hours left, Suyash took over unfinished backend work, stabilized the full-stack prototype, and presented the final system solo.</li></ul><h3>Why that matters to an employer</h3><p>The strongest signal is not “used AI agents.” It is that Suyash can inherit an incomplete system under pressure, understand unfamiliar pieces quickly, make pragmatic integration decisions, and still explain the architecture clearly. That combination of systems thinking and delivery is useful far beyond a hackathon.</p>`},
    fraudfront:{title:'FraudFront / Zinnia — Responsible AI Product Work',body:`<p>FraudFront gave Suyash experience with a different engineering constraint: an AI feature can technically work and still be unsafe, abusable, noisy, or impossible for a moderator to operate. His contribution sits at the intersection of <strong>backend integration, product safeguards, observability, and user trust</strong>.</p><h3>How he contributed</h3><ul><li>Configured and tested Python Discord bot/API workflows, slash-command behavior, environment/runtime setup, and server integration.</li><li>Worked across Supabase/PostgreSQL-backed product systems, realtime behavior, SQL/RPC workflows, security controls, rate limits, cooldowns, feature flags, spam controls, privacy behavior, monitoring, PostHog analytics planning, and an administrative kill switch.</li><li>Prepared product recommendations in language a technical or business stakeholder could act on, while keeping pilot-stage work accurately scoped.</li></ul><h3>Why this belongs in a robotics portfolio</h3><p>Autonomous systems also need guardrails, observability, fallback behavior, and responsible deployment. FraudFront shows that Suyash thinks beyond “can I make it run?” toward “how should this behave around real people?”—a mindset he carries into safety-oriented robotics and AI.</p>`},
    microgames:{title:'Scam Sprint — 657-Microgame Realtime Platform',body:`<p>Scam Sprint demonstrates a different kind of engineering endurance: preserving a very large browser experience while adding accounts, realtime multiplayer, state synchronization, mobile behavior, and persistence <strong>without breaking the hundreds of games that already worked</strong>.</p><h3>The difficult part</h3><ul><li>Maintains 657 HTML/CSS/JavaScript microgames with keyboard, touch, responsive, and cross-browser behavior.</li><li>Uses Supabase/PostgreSQL-backed identity, schema design, SQL RPCs/stored procedures, Row Level Security, rooms, scores, teams, rematches, reactions, matchmaking, cloud persistence, and realtime state.</li><li>Debugged stale rooms, score desynchronization, host/non-host behavior, cross-device identity, race conditions, rematch voting, and progress persistence.</li></ul><h3>What this proves</h3><p>Suyash can stay organized inside a sprawling codebase, reason about distributed state, and keep iterating when the bug only appears after several users, browsers, or sessions interact. Alongside robotics, it demonstrates the software depth to build the infrastructure intelligent machines increasingly depend on.</p>`}
  };
  ...
  const EVIDENCE = {
    ...
    systems:'Additional applied tooling includes SQL/PostgreSQL, Supabase Auth/Realtime, SQL schema design, stored procedures/RPCs, Row Level Security, REST APIs, Git/GitHub, Linux, JavaScript/TypeScript, HTML/CSS, AWS EC2 and cloud-computing workflows, plus applied vision tooling such as SAM, CLIP, WhisperX, Silero VAD, and OAK cameras. ROS 2, SLAM, NVIDIA Isaac Sim/Isaac Lab, and deeper C++ robotics work remain active development areas.',
    ...
    contact:'Recruiters can email suyashdash@gmail.com or use the Contact section to send a message, propose a worldwide-time-zone meeting, create a Google Calendar invitation with Suyash added as a guest, or download an RSVP-ready .ics file. A proposed time remains tentative until Suyash accepts or replies.'
  };
  ...
  async function deliverContact(payload){
    const controller=new AbortController(),timer=setTimeout(()=>controller.abort(),12000);
    try{
      const response=await fetch(CONTACT_ENDPOINT,{method:'POST',headers:{'Content-Type':'application/json','Accept':'application/json'},signal:controller.signal,body:JSON.stringify({...payload,_template:'table',_captcha:'false',_honey:''})});
  ...
  $('#message-form')?.addEventListener('submit',async e=>{
    ...
    const message=String(f.get('message')||'').trim(),name=String(f.get('name')||'').trim(),email=String(f.get('email')||'').trim(),organization=String(f.get('organization')||'Not provided').trim()||'Not provided';
    ...
    try{
      await deliverContact({_subject:`Sakura Signal — ${subject}`,name,email,organization,subject,message,'Submission type':'Portfolio contact message'});
      showToast('Message sent directly to Suyash. Thank you.');form.reset();
    }catch(error){
      console.warn('Direct contact delivery unavailable; opening email fallback.',error);
      await openPreparedEmail(subject,body,'Direct delivery was unavailable — email fallback');
  ...
  function googleCalendarInviteUrl(data){
    const dates=`${icsDate(data.start)}/${icsDate(data.end)}`,details=`${meetingSummary(data)}\n\nSave this event to send Suyash an RSVP invitation. The time remains tentative until he accepts.`;
    const url=new URL('https://calendar.google.com/calendar/r/eventedit');
    url.searchParams.set('action','TEMPLATE');url.searchParams.set('text','Meeting request with Suyash Dash');url.searchParams.set('dates',dates);url.searchParams.set('stz',data.timezone);url.searchParams.set('etz',data.timezone);url.searchParams.set('details',details);url.searchParams.set('location',data.format);url.searchParams.set('add',CONTACT_EMAIL);
    return url.toString();
  }

  $('#meeting-form')?.addEventListener('submit',async e=>{
    e.preventDefault();const data=validMeeting();if(!data)return;
    const form=e.currentTarget,button=form.querySelector('button[type="submit"]'),inviteUrl=googleCalendarInviteUrl(data);
    // Reserve the calendar tab during the click event so browsers do not block it after the async email request.
    const calendarTab=window.open('about:blank','_blank');if(calendarTab)calendarTab.opener=null;
    const summary=meetingSummary(data),body=`Hello Suyash,

I would like to request a tentative meeting time.

${summary}

I understand this time is not confirmed until you reply. I am also creating a calendar invitation so you can RSVP directly.`;
    const original=button?.textContent;if(button){button.disabled=true;button.textContent='Sending…'}
    let direct=true;
    try{
      await deliverContact({_subject:`Sakura Signal meeting request — ${data.name}`,name:data.name,email:data.email,organization:data.organization||'Not provided',purpose:data.purpose,'Proposed date':formatInZone(data.start,data.timezone,{weekday:'long',year:'numeric',month:'long',day:'numeric'}),'Proposed time':formatInZone(data.start,data.timezone,{hour:'numeric',minute:'2-digit',timeZoneName:'short'}),'Time zone':data.timezone,'Duration':`${data.duration} minutes`,'Meeting format':data.format,'Submission type':'Tentative meeting request + calendar invitation',status:'Tentative until Suyash accepts'});
    }catch(error){
      direct=false;console.warn('Direct meeting delivery unavailable; opening email fallback.',error);
      await openPreparedEmail(`Tentative meeting request — ${data.name}`,body,'Direct delivery was unavailable — meeting email fallback');
    }finally{if(button){button.disabled=false;button.textContent=original}}
    if(calendarTab){calendarTab.location.replace(inviteUrl);showToast(direct?'Request sent. Save the opened Google Calendar event to send Suyash an RSVP invite.':'Email fallback opened. Save the Google Calendar event to send Suyash an RSVP invite.');}
    else{await copyPlainText(inviteUrl);showToast('Request prepared. Popup was blocked, so the Google Calendar invitation link was copied.');}
  });
  ...
  $('#download-ics')?.addEventListener('click',()=>{
    ...
    const organizerName=escapeIcs(d.name||'Portfolio visitor');
    const text=['BEGIN:VCALENDAR','VERSION:2.0','CALSCALE:GREGORIAN','METHOD:REQUEST','PRODID:-//Suyash Dash Portfolio//Meeting Invitation//EN','BEGIN:VEVENT',`UID:${Date.now()}-${Math.random().toString(36).slice(2)}@suyashdash-portfolio`,`DTSTAMP:${icsDate(new Date())}`,`DTSTART:${icsDate(d.start)}`,`DTEND:${icsDate(d.end)}`,'SUMMARY:Meeting request with Suyash Dash',`DESCRIPTION:${escapeIcs(meetingSummary(d))}`,`LOCATION:${escapeIcs(d.format)}`,`ORGANIZER;CN=${organizerName}:mailto:${d.email}`,`ATTENDEE;CN=Suyash Dash;ROLE=REQ-PARTICIPANT;PARTSTAT=NEEDS-ACTION;RSVP=TRUE:mailto:${CONTACT_EMAIL}`,'SEQUENCE:0','STATUS:TENTATIVE','TRANSP:OPAQUE','END:VEVENT','END:VCALENDAR'].join('\r\n');
    downloadBlob(text,'text/calendar;charset=utf-8','suyash-dash-meeting-invitation.ics');showToast('RSVP-ready calendar invitation downloaded.');
  });

  $('#open-google-calendar')?.addEventListener('click',()=>{
    const d=validMeeting();if(!d)return;const inviteUrl=googleCalendarInviteUrl(d);
    const opened=window.open(inviteUrl,'_blank','noopener,noreferrer');if(!opened){copyPlainText(inviteUrl);showToast('Popup blocked—the RSVP-ready Google Calendar link was copied.')}else showToast('Save the Google Calendar event to send Suyash the RSVP invitation.');
  });
  ...
  $('#settings-open').addEventListener('click',()=>openModal('#settings-modal'));$('#mobile-settings-open')?.addEventListener('click',()=>{const sheet=$('#mobile-sheet');if(sheet)sheet.hidden=true;openModal('#settings-modal')});$('#setting-theme')?.addEventListener('change',e=>{applyTheme(e.target.value);showToast(`Theme changed to ${THEME_META.find(x=>x[0]===e.target.value)?.[1]||'Sakura Original'}.`)});$('#setting-sound').addEventListener('change',e=>setSound(e.target.checked));$('#setting-motion').addEventListener('change',e=>{state.reducedMotion=e.target.checked;document.documentElement.dataset.reducedMotion=state.reducedMotion?'1':'0';localStorage.setItem('sd-reduced-motion',state.reducedMotion?'1':'0');if(state.reducedMotion&&state.edgeSignal==='flow')setEdgeSignal('static',{silent:true});showToast('Motion preference saved. Refresh to fully apply it.')});$('#setting-intro').addEventListener('change',e=>{state.alwaysIntro=e.target.checked;localStorage.setItem('sd-always-intro',state.alwaysIntro?'1':'0')});const openLocationConsent=()=>openModal('#location-consent-modal');$('#settings-location').addEventListener('click',openLocationConsent);$('#location-sync').addEventListener('click',openLocationConsent);$('#location-consent-confirm')?.addEventListener('click',()=>{closeModal($('#location-consent-modal'));requestPreciseLocation(true)});$('#sound-toggle').addEventListener('click',()=>setSound(!state.sound));$('#replay-intro').addEventListener('click',()=>runIntro(true));$('#intro-skip').addEventListener('click',()=>finishIntro());$('#recruiter-brief').addEventListener('click',()=>openModal('#brief-modal'));

  /* Guided recruiter tour — route-aware, event-driven, and zero idle rendering cost. */
  const SIGNAL_TOUR_STEPS=[
    {route:'home',kicker:'01 · SYSTEMS RANGE',title:'Start with the engineering range',copy:'The homepage establishes the pattern: physical robotics, computer vision, autonomous systems, and AI/software are connected into systems a team can test, explain, and improve.'},
    {route:'robotics',kicker:'02 · PHYSICAL ROBOTICS',title:'From geometry to autonomous motion',copy:'The Robot Lab shows FANUC and YAMAHA work where CAD, end-effectors, teach-pendant logic, sensors, I/O, suction, sequencing, and safety all have to agree.'},
    {route:'projects',kicker:'03 · PERCEPTION + AI',title:'Build intelligence around real constraints',copy:'Projects connect RoBoat perception, multimodal vehicle-safety research, LifeOS orchestration, and realtime software—not as isolated demos, but as evidence of end-to-end problem solving.'},
    {route:'technology',kicker:'04 · ENGINEERING STACK',title:'See what is demonstrated versus developing',copy:'The technology view ties tools to actual projects and keeps growth areas honest, from Python/PyTorch/YOLO and PostgreSQL/AWS EC2 to ROS 2 and simulation work in progress.'},
    {route:'contact',kicker:'05 · NEXT STEP',title:'Turn evidence into a conversation',copy:'The final step makes it easy to contact Suyash, propose a tentative meeting, or use Dash AI and Role Match to ask role-specific questions before reaching out.'}
  ];
  let signalTourIndex=0;
  function renderSignalTour({navigate=true}={}){
    const step=SIGNAL_TOUR_STEPS[signalTourIndex];if(!step)return;
    if(navigate)routeTo(step.route);
    const count=$('#signal-tour-count'),bar=$('#signal-tour-bar'),kicker=$('#signal-tour-kicker'),title=$('#signal-tour-step-title'),copy=$('#signal-tour-copy'),back=$('#signal-tour-back'),next=$('#signal-tour-next');
    if(count)count.textContent=`${signalTourIndex+1} of ${SIGNAL_TOUR_STEPS.length}`;
    if(bar)bar.style.width=`${((signalTourIndex+1)/SIGNAL_TOUR_STEPS.length)*100}%`;
    if(kicker)kicker.textContent=step.kicker;if(title)title.textContent=step.title;if(copy)copy.textContent=step.copy;
    if(back)back.disabled=signalTourIndex===0;if(next)next.textContent=signalTourIndex===SIGNAL_TOUR_STEPS.length-1?'Finish':'Next →';
  }
  function startSignalTour(){signalTourIndex=0;openModal('#signal-tour-modal');renderSignalTour()}
  $('#settings-tour-start')?.addEventListener('click',()=>{closeModal($('#settings-modal'));setTimeout(startSignalTour,40)});
  $('#signal-tour-back')?.addEventListener('click',()=>{if(signalTourIndex>0){signalTourIndex--;renderSignalTour()}});
  $('#signal-tour-open')?.addEventListener('click',()=>{const step=SIGNAL_TOUR_STEPS[signalTourIndex];if(step)routeTo(step.route)});
  $('#signal-tour-next')?.addEventListener('click',()=>{if(signalTourIndex>=SIGNAL_TOUR_STEPS.length-1){closeModal($('#signal-tour-modal'));showToast('Tour complete — explore any section or ask Dash AI a role-specific question.');return}signalTourIndex++;renderSignalTour()});

  const themePopover=$('#theme-popover'),themeOpen=$('#theme-quick-open');
  function openThemePicker(){if(!themePopover)return;themePopover.hidden=false;themeOpen?.setAttribute('aria-expanded','true');requestAnimationFrame(()=>themePopover.classList.add('is-open'))}
  function closeThemePicker(){if(!themePopover)return;themePopover.classList.remove('is-open');themeOpen?.setAttribute('aria-expanded','false');setTimeout(()=>{if(!themePopover.classList.contains('is-open'))themePopover.hidden=true},140)}
  themeOpen?.addEventListener('click',e=>{e.stopPropagation();themePopover?.hidden?openThemePicker():closeThemePicker()});$('#theme-quick-close')?.addEventListener('click',closeThemePicker);$('#theme-open-settings')?.addEventListener('click',()=>{closeThemePicker();openModal('#settings-modal')});
  addEventListener('pointerdown',e=>{if(themePopover&&!themePopover.hidden&&!themePopover.contains(e.target)&&e.target!==themeOpen)closeThemePicker()},{passive:true});
  addEventListener('keydown',e=>{const typing=/INPUT|TEXTAREA|SELECT/.test(document.activeElement?.tagName||'');if(e.key==='Escape'&&themePopover&&!themePopover.hidden)closeThemePicker();if(!typing&&!e.ctrlKey&&!e.metaKey&&!e.altKey){const key=e.key.toLowerCase();if(key==='t'){e.preventDefault();openThemePicker()}else if(key==='l'){e.preventDefault();openLanguage()}else if(key==='b'){e.preventDefault();openModal('#brief-modal')}}});
  let activeThemeFilter='All';
  $$('.theme-filter-row [data-theme-filter]').forEach(button=>button.addEventListener('click',()=>{
    const requested=button.dataset.themeFilter||'All';
    if(requested==='Random'){
      $$('.theme-filter-row [data-theme-filter]').forEach(x=>x.classList.toggle('is-active',x===button));
      randomizeTheme();
      setTimeout(()=>$$('.theme-filter-row [data-theme-filter]').forEach(x=>x.classList.toggle('is-active',x.dataset.themeFilter===activeThemeFilter)),420);
      return;
    }
    activeThemeFilter=requested;
    $$('.theme-filter-row [data-theme-filter]').forEach(x=>x.classList.toggle('is-active',x===button));
    renderThemeGallery($('#quick-theme-grid'),activeThemeFilter);
  }));
  renderThemeGallery($('#quick-theme-grid'),activeThemeFilter);
  $('#theme-randomize')?.addEventListener('click',randomizeTheme);
  $('#settings-theme-randomize')?.addEventListener('click',randomizeTheme);
  const themeSelect=$('#setting-theme');
  if(themeSelect){
    const groups=['Signature','Professional','City','Editor','Pop Culture'];
    themeSelect.innerHTML=groups.map(group=>`<optgroup label="${group}">${THEME_META.filter(x=>x[4]===group).map(([id,name])=>`<option value="${id}">${name}</option>`).join('')}</optgroup>`).join('');
  }

  const LANGUAGE_META=[
    ['en','English','Original'],['ja','日本語','Japanese'],['hi','हिन्दी','Hindi'],
    ['es','Español','Spanish'],['fr','Français','French'],['de','Deutsch','German'],
    ['ko','한국어','Korean'],['zh-CN','中文','Chinese'],['pt','Português','Portuguese'],
    ['it','Italiano','Italian'],['ar','العربية','Arabic'],['nl','Nederlands','Dutch'],
  ...
  function setGlow(value,{silent=false}={}){
    const next=['subtle','signature','vivid'].includes(value)?value:'signature';state.glow=next;document.documentElement.dataset.glow=next;try{localStorage.setItem('sd-glow',next)}catch{};$$('[data-glow-choice]').forEach(b=>{const active=b.dataset.glowChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});if(!silent)showToast(`Signal intensity: ${next}.`);
  }
  function setSurface(value,{silent=false}={}){
    const next=value==='solid'?'solid':'glass';state.surface=next;document.documentElement.dataset.surface=next;try{localStorage.setItem('sd-surface',next)}catch{};$$('[data-surface-choice]').forEach(b=>{const active=b.dataset.surfaceChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});if(!silent)showToast(next==='solid'?'Solid surfaces enabled for stronger contrast.':'Glass surfaces restored.');
  }
  function setFocusRing(value,{silent=false}={}){
    const next=value==='enhanced'?'enhanced':'standard';state.focusRing=next;document.documentElement.dataset.focusRing=next;try{localStorage.setItem('sd-focus-ring',next)}catch{};$$('[data-focus-ring-choice]').forEach(b=>{const active=b.dataset.focusRingChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});if(!silent)showToast(next==='enhanced'?'Enhanced keyboard focus enabled.':'Standard keyboard focus restored.');
  }
  function setLinkClarity(value,{silent=false}={}){
    const next=value==='underlined'?'underlined':'standard';state.linkClarity=next;document.documentElement.dataset.linkClarity=next;try{localStorage.setItem('sd-link-clarity',next)}catch{};$$('[data-link-choice]').forEach(b=>{const active=b.dataset.linkChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});if(!silent)showToast(next==='underlined'?'Link underlines enabled.':'Standard link styling restored.');
  }
  function setTextComfort(value,{silent=false}={}){
    const next=value==='comfortable'?'comfortable':'standard';state.textComfort=next;document.documentElement.dataset.textComfort=next;try{localStorage.setItem('sd-text-comfort',next)}catch{};$$('[data-text-comfort-choice]').forEach(b=>{const active=b.dataset.textComfortChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});if(!silent)showToast(next==='comfortable'?'Comfortable reading size enabled.':'Standard reading size restored.');
  }
  function setSignalLens(value,{silent=false}={}){
    const valid=['balanced','robotics','ai','research'];const next=valid.includes(value)?value:'balanced';state.signalLens=next;document.documentElement.dataset.signalLens=next;try{localStorage.setItem('sd-signal-lens',next)}catch{};$$('[data-signal-lens-choice]').forEach(b=>{const active=b.dataset.signalLensChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});if(!silent){const labels={balanced:'Balanced',robotics:'Robotics',ai:'AI / Software',research:'Research'};showToast(`Signal lens: ${labels[next]}. All portfolio evidence remains available.`)}
  }
  function setResumeLastRoute(enabled,{silent=false}={}){state.resumeLastRoute=Boolean(enabled);try{localStorage.setItem('sd-resume-route',state.resumeLastRoute?'1':'0')}catch{};const input=$('#setting-resume-route');if(input)input.checked=state.resumeLastRoute;if(!silent)showToast(state.resumeLastRoute?'This device will reopen your last portfolio section.':'The portfolio will start on Home.')}
  let readingProgressFrame=0;
  function updateReadingProgress(){
    const root=document.documentElement,bar=$('#reading-progress i');if(!bar)return;
    const max=Math.max(1,root.scrollHeight-innerHeight),progress=clamp(scrollY/max,0,1);bar.style.transform=`scaleX(${progress})`;
  }
  function queueReadingProgress(){if(!state.readingProgress||readingProgressFrame)return;readingProgressFrame=requestAnimationFrame(()=>{readingProgressFrame=0;updateReadingProgress()})}
  function setReadingProgress(enabled,{silent=false}={}){state.readingProgress=Boolean(enabled);document.documentElement.dataset.readingProgress=state.readingProgress?'1':'0';try{localStorage.setItem('sd-reading-progress',state.readingProgress?'1':'0')}catch{};const input=$('#setting-reading-progress');if(input)input.checked=state.readingProgress;updateReadingProgress();if(!silent)showToast(state.readingProgress?'Reading progress enabled.':'Reading progress hidden.')}
  function setShortcutHints(enabled,{silent=false}={}){state.shortcutHints=Boolean(enabled);document.documentElement.dataset.shortcutHints=state.shortcutHints?'1':'0';try{localStorage.setItem('sd-shortcut-hints',state.shortcutHints?'1':'0')}catch{};const input=$('#setting-shortcut-hints');if(input)input.checked=state.shortcutHints;if(!silent)showToast(state.shortcutHints?'Keyboard shortcut hints shown.':'Keyboard shortcut hints hidden.')}
  function setEdgeSignal(value,{silent=false}={}){const valid=['off','static','flow'];let next=valid.includes(value)?value:'off';if(next==='flow'&&state.reducedMotion)next='static';state.edgeSignal=next;document.documentElement.dataset.edgeSignal=next;try{localStorage.setItem('sd-edge-signal',next)}catch{};$$('[data-edge-signal-choice]').forEach(b=>{const active=b.dataset.edgeSignalChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});if(!silent){const labels={off:'Neon edge signal off.',static:'Theme-colored neon outline enabled.',flow:'Theme-colored ambient neon flow enabled.'};showToast(labels[next])}}
  addEventListener('scroll',queueReadingProgress,{passive:true});addEventListener('resize',queueReadingProgress,{passive:true});
  function applyExperienceProfile(value){
    const profile=value||'balanced';
    if(profile==='recruiter'){setDensity('compact',{silent:true});setGlow('subtle',{silent:true});setSurface('solid',{silent:true});setFocusRing('standard',{silent:true});setLinkClarity('underlined',{silent:true});setTextComfort('standard',{silent:true});setSignalLens('balanced',{silent:true});showToast('Recruiter profile applied: denser evidence, clearer links, solid surfaces.');return}
    if(profile==='accessible'){setDensity('comfortable',{silent:true});setGlow('subtle',{silent:true});setSurface('solid',{silent:true});setFocusRing('enhanced',{silent:true});setLinkClarity('underlined',{silent:true});setTextComfort('comfortable',{silent:true});showToast('Accessible profile applied: stronger focus, larger text, solid surfaces.');return}
    if(profile==='showcase'){setDensity('balanced',{silent:true});setGlow('vivid',{silent:true});setSurface('glass',{silent:true});setFocusRing('standard',{silent:true});setLinkClarity('standard',{silent:true});setTextComfort('standard',{silent:true});showToast('Showcase profile applied: full Sakura presentation styling.');return}
    setDensity('balanced',{silent:true});setGlow('signature',{silent:true});setSurface('glass',{silent:true});setFocusRing('standard',{silent:true});setLinkClarity('standard',{silent:true});setTextComfort('standard',{silent:true});setSignalLens('balanced',{silent:true});showToast('Balanced profile restored.');
  }
  function setSceneResolution(value,{silent=false}={}){
    const valid=['auto','480','720','1080','1440','2160'];const next=valid.includes(String(value))?String(value):'auto';state.sceneResolution=next;document.documentElement.dataset.sceneResolution=next;try{localStorage.setItem('sd-scene-resolution',next)}catch{};const select=$('#setting-resolution');if(select&&select.value!==next)select.value=next;window.dispatchEvent(new CustomEvent('sakura:render-preference',{detail:{resolution:next,fps:state.fpsPreference}}));if(!silent)showToast(next==='auto'?'Scene resolution returned to adaptive AUTO.':`Scene resolution requested: ${next==='2160'?'4K':next+'p'}. Quality mode may cap it to protect performance.`);
  }
  function setFpsPreference(value,{silent=false}={}){
    const valid=['auto','15','24','30'];const next=valid.includes(String(value))?String(value):'auto';state.fpsPreference=next;document.documentElement.dataset.fpsPreference=next;try{localStorage.setItem('sd-fps-preference',next)}catch{};$$('[data-fps-choice]').forEach(b=>{const active=b.dataset.fpsChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});window.dispatchEvent(new CustomEvent('sakura:render-preference',{detail:{resolution:state.sceneResolution,fps:next}}));if(!silent)showToast(next==='auto'?'Frame rate returned to adaptive AUTO.':`Motion target requested: ${next} FPS. Quality mode keeps a safe cap.`);
  }
  function setTimeFormat(value,{silent=false}={}){
    const next=value==='24'?'24':'12';state.timeFormat=next;try{localStorage.setItem('sd-time-format',next)}catch{};$$('[data-time-choice]').forEach(b=>{const active=b.dataset.timeChoice===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});window.dispatchEvent(new CustomEvent('sakura:clock-format',{detail:{format:next}}));if(!silent)showToast(next==='24'?'24-hour time enabled.':'12-hour time enabled.');
  }
  function setTemperatureUnit(value,{silent=false}={}){
    const next=value==='C'?'C':'F';state.temperatureUnit=next;try{localStorage.setItem('sd-temperature-unit',next)}catch{};$$('[data-temp-unit]').forEach(b=>{const active=b.dataset.tempUnit===next;b.classList.toggle('is-active',active);b.setAttribute('aria-pressed',String(active))});renderTemperature();if(!silent)showToast(`Temperature unit: °${next}.`);
  }
  function renderTemperature(){
    const el=$('#local-temperature');if(!el)return;if(!state.temperatureEnabled||!Number.isFinite(state.temperatureC)){el.hidden=true;return}const value=state.temperatureUnit==='C'?state.temperatureC:(state.temperatureC*9/5+32);el.textContent=`${Math.round(value)}°${state.temperatureUnit}`;el.hidden=false;
  }
  let weatherAbort=null,lastWeatherKey='';
  async function refreshLocalTemperature({force=false}={}){
    if(!state.temperatureEnabled||!state.coords||state.locationSource!=='precise'){state.temperatureC=null;renderTemperature();return}
    const lat=Math.round(state.coords.lat*10)/10,lng=Math.round(state.coords.lng*10)/10,key=`${lat},${lng}`;
    try{const cached=JSON.parse(sessionStorage.getItem('sd-weather-cache-v1')||'null');if(!force&&cached&&cached.key===key&&Date.now()-cached.at<15*60*1000&&Number.isFinite(cached.c)){state.temperatureC=cached.c;renderTemperature();return}}catch{}
    weatherAbort?.abort?.();weatherAbort=new AbortController();const timer=setTimeout(()=>weatherAbort.abort(),5000);
    try{const url=`https://api.open-meteo.com/v1/forecast?latitude=${encodeURIComponent(lat)}&longitude=${encodeURIComponent(lng)}&current=temperature_2m&temperature_unit=celsius&timezone=auto`;const response=await fetch(url,{cache:'no-store',signal:weatherAbort.signal});if(!response.ok)throw new Error(`Weather HTTP ${response.status}`);const data=await response.json();const c=Number(data?.current?.temperature_2m);if(!Number.isFinite(c))throw new Error('Temperature unavailable');state.temperatureC=c;lastWeatherKey=key;try{sessionStorage.setItem('sd-weather-cache-v1',JSON.stringify({key,c,at:Date.now()}))}catch{};renderTemperature()}catch{state.temperatureC=null;renderTemperature()}finally{clearTimeout(timer)}
  }
  function setTemperatureEnabled(enabled,{silent=false}={}){
    state.temperatureEnabled=Boolean(enabled);try{localStorage.setItem('sd-temperature-enabled',state.temperatureEnabled?'1':'0')}catch{};const input=$('#setting-temperature');if(input)input.checked=state.temperatureEnabled;if(state.temperatureEnabled){refreshLocalTemperature({force:true});if(state.locationSource!=='precise'&&!silent)showToast('Temperature will appear after precise location is available.')}else{state.temperatureC=null;renderTemperature();if(!silent)showToast('Local temperature hidden.')}
  }
  function updateRenderStatus(detail={}){const resolution=$('#resolution-effective'),fps=$('#fps-effective');if(resolution&&detail.effectiveHeight)resolution.textContent=`Effective live-scene height: about ${detail.effectiveHeight}p • ${String(detail.quality||'eco').toUpperCase()} safety cap active.`;if(fps&&detail.fps)fps.textContent=`Effective target: ${Math.round(detail.fps)} FPS • adapts downward if the device struggles.`}
  addEventListener('sakura:render-status',event=>updateRenderStatus(event.detail||{}));
  async function shareCurrent(){const url=location.href,title=`Suyash Dash — ${document.querySelector('.view.is-active h1,.view.is-active h2')?.textContent?.trim()||'Portfolio'}`;try{if(navigator.share){await navigator.share({title,url});return}await navigator.clipboard.writeText(url);showToast('Current portfolio link copied.')}catch{try{await navigator.clipboard.writeText(url);showToast('Current portfolio link copied.')}catch{showToast('Share was blocked by the browser.')}}}
  const openRecruiterBrief=()=>openModal('#brief-modal');
  $('#language-open')?.addEventListener('click',openLanguage);$('#settings-language-open')?.addEventListener('click',openLanguage);$('#language-quick-open')?.addEventListener('click',openLanguage);$('#side-language-open')?.addEventListener('click',openLanguage);$('#side-language-quick')?.addEventListener('click',openLanguage);$('#mobile-language-open')?.addEventListener('click',()=>{const sheet=$('#mobile-sheet');if(sheet)sheet.hidden=true;openLanguage()});
  $('#side-theme-quick')?.addEventListener('click',openThemePicker);$('#mobile-theme-open')?.addEventListener('click',()=>{const sheet=$('#mobile-sheet');if(sheet)sheet.hidden=true;openThemePicker()});
  $('#settings-theme-browse')?.addEventListener('click',()=>{closeModal($('#settings-modal'));openThemePicker()});
  $$('[data-theme-mode]').forEach(b=>b.addEventListener('click',()=>setThemeMode(b.dataset.themeMode)));$('#setting-resume-route')?.addEventListener('change',e=>setResumeLastRoute(e.target.checked));
  $('#side-brief-quick')?.addEventListener('click',()=>openModal('#brief-modal'));$('#mobile-brief-open')?.addEventListener('click',()=>{const sheet=$('#mobile-sheet');if(sheet)sheet.hidden=true;openModal('#brief-modal')});
  $('#focus-toggle')?.addEventListener('click',()=>setFocusMode(!state.focusMode));$('#settings-focus-toggle')?.addEventListener('click',()=>setFocusMode(!state.focusMode));
  $$('[data-density-choice]').forEach(button=>button.addEventListener('click',()=>setDensity(button.dataset.densityChoice)));$$('[data-glow-choice]').forEach(button=>button.addEventListener('click',()=>setGlow(button.dataset.glowChoice)));$$('[data-surface-choice]').forEach(button=>button.addEventListener('click',()=>setSurface(button.dataset.surfaceChoice)));$$('[data-focus-ring-choice]').forEach(button=>button.addEventListener('click',()=>setFocusRing(button.dataset.focusRingChoice)));
  $$('[data-link-choice]').forEach(button=>button.addEventListener('click',()=>setLinkClarity(button.dataset.linkChoice)));$$('[data-text-comfort-choice]').forEach(button=>button.addEventListener('click',()=>setTextComfort(button.dataset.textComfortChoice)));$$('[data-signal-lens-choice]').forEach(button=>button.addEventListener('click',()=>setSignalLens(button.dataset.signalLensChoice)));$$('[data-experience-profile]').forEach(button=>button.addEventListener('click',()=>applyExperienceProfile(button.dataset.experienceProfile)));$$('[data-fps-choice]').forEach(button=>button.addEventListener('click',()=>setFpsPreference(button.dataset.fpsChoice)));$$('[data-time-choice]').forEach(button=>button.addEventListener('click',()=>setTimeFormat(button.dataset.timeChoice)));$$('[data-temp-unit]').forEach(button=>button.addEventListener('click',()=>setTemperatureUnit(button.dataset.tempUnit)));$('#setting-resolution')?.addEventListener('change',e=>setSceneResolution(e.target.value));$('#setting-temperature')?.addEventListener('change',e=>setTemperatureEnabled(e.target.checked));$('#setting-reading-progress')?.addEventListener('change',e=>setReadingProgress(e.target.checked));$('#setting-shortcut-hints')?.addEventListener('change',e=>setShortcutHints(e.target.checked));$$('[data-edge-signal-choice]').forEach(button=>button.addEventListener('click',()=>setEdgeSignal(button.dataset.edgeSignalChoice)));
  const headerClock=$('#current-time');if(headerClock){const toggleClock=()=>setTimeFormat(state.timeFormat==='24'?'12':'24');headerClock.addEventListener('click',toggleClock);headerClock.addEventListener('keydown',e=>{if(e.key==='Enter'||e.key===' '){e.preventDefault();toggleClock()}})}
  const headerTemperature=$('#local-temperature');if(headerTemperature){const toggleTemperatureUnit=()=>setTemperatureUnit(state.temperatureUnit==='F'?'C':'F');headerTemperature.addEventListener('click',toggleTemperatureUnit);headerTemperature.addEventListener('keydown',e=>{if(e.key==='Enter'||e.key===' '){e.preventDefault();toggleTemperatureUnit()}})}
  $('#share-page')?.addEventListener('click',shareCurrent);$('#settings-share-page')?.addEventListener('click',shareCurrent);
  $('#quick-recruiter-brief')?.addEventListener('click',openRecruiterBrief);$('#settings-recruiter-brief')?.addEventListener('click',openRecruiterBrief);
  setFocusMode(state.focusMode,{silent:true});setDensity(state.density,{silent:true});setGlow(state.glow,{silent:true});setSurface(state.surface,{silent:true});setFocusRing(state.focusRing,{silent:true});setTextComfort(state.textComfort,{silent:true});setSignalLens(state.signalLens,{silent:true});setReadingProgress(state.readingProgress,{silent:true});setShortcutHints(state.shortcutHints,{silent:true});setEdgeSignal(state.edgeSignal,{silent:true});renderLanguageGrid();

  applyTheme(state.theme,{save:false});$('#setting-theme').value=state.theme;$('#setting-sound').checked=state.sound;$('#setting-motion').checked=state.reducedMotion;$('#setting-intro').checked=state.alwaysIntro;setSound(state.sound);setThemeMode(state.themeMode,{silent:true});setResumeLastRoute(state.resumeLastRoute,{silent:true});
  ...
  function init(){
    ...
    $$('.nav-item span,.mobile-dock span,.side-utility-strip span,.sky-controls span,.social-row,.logo-orbit,.ai-fab-core').forEach(el=>el.setAttribute('translate','no'));
    const perf=window.__SAKURA_PERF_PROFILE__||{constrained:false,veryConstrained:false};const ambientPetals=perf.veryConstrained?0:perf.constrained?3:6;
    for(let i=0;i<ambientPetals;i++){const p=document.createElement('i');p.className='petal';p.style.left=`${65+Math.random()*38}%`;p.style.animationDuration=`${9+Math.random()*12}s`;p.style.animationDelay=`-${Math.random()*16}s`;p.style.setProperty('--drift',`${-180+Math.random()*320}px`);p.style.opacity=`${.26+Math.random()*.48}`;$('#petal-layer').appendChild(p)}
    const portraitSource=$('#home-portrait')?.src;if(portraitSource)$$('[data-portrait-copy]').forEach(img=>{img.src=portraitSource});
    animateLifeOS();animateAutonomy();
    buildDynamicSearchIndex();
    const parsed=parseHash();if(!location.hash&&state.resumeLastRoute){const remembered=localStorage.getItem('sd-last-route');if(validRoutes.has(remembered))parsed.route=remembered}state.route='';routeTo(parsed.route,parsed.anchor);
    populateTimeZones();
    setDensity(state.density,{silent:true});setGlow(state.glow,{silent:true});setSurface(state.surface,{silent:true});setFocusRing(state.focusRing,{silent:true});setLinkClarity(state.linkClarity,{silent:true});setTextComfort(state.textComfort,{silent:true});setSignalLens(state.signalLens,{silent:true});setReadingProgress(state.readingProgress,{silent:true});setShortcutHints(state.shortcutHints,{silent:true});setEdgeSignal(state.edgeSignal,{silent:true});setSceneResolution(state.sceneResolution,{silent:true});setFpsPreference(state.fpsPreference,{silent:true});setTimeFormat(state.timeFormat,{silent:true});setTemperatureUnit(state.temperatureUnit,{silent:true});setTemperatureEnabled(state.temperatureEnabled,{silent:true});
    ...
    runIntro(false);
    // Precise location is optional. Never trigger a browser permission prompt on arrival.
    // If the visitor has already granted permission previously, reuse it silently.
    if(!sessionStorage.getItem('sd-sky-coords-v3')&&navigator.permissions?.query){
...
(() => {
  ...
  function inferCoords(){
    try{const saved=JSON.parse(sessionStorage.getItem('sd-sky-coords-v3')||'null');if(saved&&Number.isFinite(saved.lat)&&Number.isFinite(saved.lng))return saved}catch{}
    const zone=Intl.DateTimeFormat().resolvedOptions().timeZone||'UTC';
    return __sakuraApproxCoordsForZone(zone);
  }
  ...
  const wallClockCache=new Map();
  function wallClockParts(d){
    const zone=(typeof activeWorldTimeZone!=='undefined'&&activeWorldTimeZone)||Intl.DateTimeFormat().resolvedOptions().timeZone||'UTC';
    const key=`${zone}|${Math.floor(d.getTime()/60000)}`;if(wallClockCache.has(key))return wallClockCache.get(key);
    const parts=Object.fromEntries(new Intl.DateTimeFormat('en-US',{timeZone:zone,hour12:false,hour:'2-digit',minute:'2-digit',second:'2-digit',year:'numeric',month:'2-digit',day:'2-digit'}).formatToParts(d).filter(p=>p.type!=='literal').map(p=>[p.type,p.value]));
    const value={hour:Number(parts.hour)%24,minute:Number(parts.minute),second:Number(parts.second),year:Number(parts.year),month:Number(parts.month),day:Number(parts.day)};
    if(wallClockCache.size>32)wallClockCache.clear();wallClockCache.set(key,value);return value;
  }
  function minuteValue(d){const p=wallClockParts(d);return p.hour*60+p.minute+p.second/60}
  function eventMinute(d){return d?minuteValue(d):null}
  ...
  let quality='eco';try{const savedQuality=localStorage.getItem('sd-v24-quality');quality=['eco','auto','high'].includes(savedQuality)?savedQuality:'eco';if(!savedQuality||savedQuality!==quality)localStorage.setItem('sd-v24-quality',quality)}catch{}
  let sceneResolution='auto',fpsPreference='auto',clockFormat='12';try{sceneResolution=localStorage.getItem('sd-scene-resolution')||'auto';fpsPreference=localStorage.getItem('sd-fps-preference')||'auto';clockFormat=localStorage.getItem('sd-time-format')||'12'}catch{}
  document.documentElement.dataset.renderQuality=quality;document.documentElement.dataset.sceneResolution=sceneResolution;document.documentElement.dataset.fpsPreference=fpsPreference;
  let currentRenderScale=1;
  // AUTO can lower its internal resolution again if a real device is still
  // missing its frame target. HIGH is never silently changed.
  let autoDprCap=.66, adaptiveDetail=1, lowFpsStrikes=0, lastAdaptiveResize=0;

  function qualityResolutionCap(){
    const perf=window.__SAKURA_PERF_PROFILE__||{};if(quality==='eco')return perf.veryConstrained?540:perf.constrained?720:900;if(quality==='auto')return perf.veryConstrained?540:perf.constrained?720:1080;return perf.veryConstrained?720:perf.constrained?1080:2160;
  }
  function chooseDpr(){
    const native=devicePixelRatio||1,perf=window.__SAKURA_PERF_PROFILE__||{worldDpr:.88};let automatic;
    if(quality==='high')automatic=Math.min(native,.96);
    else if(quality==='eco')automatic=Math.min(native,perf.ecoDpr||.62,qualityResolutionCap()/Math.max(1,cssH));
    else{const pixels=innerWidth*innerHeight,sizeCap=pixels>3000000?.48:pixels>2000000?.54:pixels>1200000?.60:.66;automatic=Math.min(native,perf.worldDpr,sizeCap,autoDprCap)}
    if(sceneResolution==='auto')return automatic;
    const requested=Number(sceneResolution);if(!Number.isFinite(requested))return automatic;const safeTarget=Math.min(requested,qualityResolutionCap()),requestedDpr=safeTarget/Math.max(1,cssH);return Math.min(native,Math.max(.22,requestedDpr));
  }
  function chooseTargetFps(){
    const perf=window.__SAKURA_PERF_PROFILE__||{worldFps:24,ecoFps:18,constrained:false,veryConstrained:false};const automatic=quality==='high'?30:quality==='eco'?(perf.ecoFps||18):(perf.worldFps||24);if(fpsPreference==='auto')return automatic;const requested=Number(fpsPreference)||automatic;const safeCap=quality==='high'?(perf.veryConstrained?18:perf.constrained?24:30):quality==='eco'?Math.min(24,perf.ecoFps||18):Math.min(30,perf.worldFps||24);return Math.max(10,Math.min(requested,safeCap));
  }
  function broadcastRenderStatus(){try{window.dispatchEvent(new CustomEvent('sakura:render-status',{detail:{quality,sceneResolution,effectiveHeight:Math.round(cssH*dpr),fps:chooseTargetFps()}}))}catch{}}
  function resize(){
  ...
  const worldPerf=window.__SAKURA_PERF_PROFILE__||{detail:1,constrained:false,veryConstrained:false,worldFps:24,ecoFps:18};adaptiveDetail=quality==='eco'?Math.max(.26,worldPerf.detail):1;
  ...
  const hillFlowers=Array.from({length:detailCount(560,260)},(_,i)=>({x:rng.range(715,1915),y:rng.range(760,1060),r:rng.range(1.1,3.5),c:rng.pick(['#ff9fc9','#ffd5e7','#a9d8ff','#fff0b7','#b5eba8']),p:rng.range(0,TAU)}));
  const grassBlades=Array.from({length:detailCount(190,90)},(_,i)=>({x:rng.range(720,1910),y:rng.range(735,1060),len:rng.range(8,24),p:rng.range(0,TAU),w:rng.range(.6,1.8)}));
  const petals=Array.from({length:detailCount(96,45)},()=>({x:rng.range(0,W),y:rng.range(-80,H),vx:rng.range(9,30),vy:rng.range(5,18),size:rng.range(2,6),p:rng.range(0,TAU),rot:rng.range(0,TAU),depth:rng.range(.45,1.2)}));
  const fireflies=Array.from({length:detailCount(28,14)},()=>({x:rng.range(850,1880),y:rng.range(700,1000),p:rng.range(0,TAU),s:rng.range(.5,1.5)}));
  const birds=Array.from({length:detailCount(12,7)},()=>({x:rng.range(-200,W),y:rng.range(160,430),speed:rng.range(10,26),p:rng.range(0,TAU),s:rng.range(.5,1.1)}));
  const skyMotes=Array.from({length:detailCount(54,24)},(_,i)=>({x:rng.range(40,W-40),y:rng.range(90,520),p:rng.range(0,TAU),s:rng.range(.45,1.3),r:rng.range(.45,1.7)}));
  const shootingStars=[
  ...
  function sunScene(date,times,alt){const sr=times.sunrise?.getTime(),ss=times.sunset?.getTime(),t=date.getTime();let p=Number.isFinite(sr)&&Number.isFinite(ss)?(t-sr)/(ss-sr):((minuteValue(date)/60)-6)/12;return{x:115+1690*p,y:HORIZON-10-Math.max(0,Math.sin(clamp(p)*Math.PI))*465,p,visible:alt>-5}}
  ...
  function sleepAmount(date){const m=minuteValue(date);if(m>=22*60||m<5*60)return 1;if(m>=20.25*60)return smooth(invLerp(20.25*60,22*60,m));if(m<6.7*60)return 1-smooth(invLerp(5*60,6.7*60,m));return 0}
  function relaxedAmount(date){const m=minuteValue(date);if(m<17*60)return .08;if(m<20.6*60)return lerp(.08,.72,smoother(invLerp(17*60,20.6*60,m)));return .78}
  ...
  function drawCloudShape(c,cloud,pal,t){
    ...
    if(quality==='high'){c.filter=`brightness(${.66+cloud.depth*.2}) saturate(.82)`;c.shadowColor=rgb(pal.light,.09);c.shadowBlur=8}
    ...
    c.globalCompositeOperation='screen';c.globalAlpha*=.30;if(quality==='high')c.filter='blur(.7px)';
    c.drawImage(sprite,-266,-112);c.filter='none';c.shadowBlur=0;c.restore();
  }
  ...
  function drawStars(alpha,t){
    ...
    const starStep=quality==='high'?1:(adaptiveDetail<.62?3:adaptiveDetail<.82?2:1);
    for(let si=0;si<stars.length;si+=starStep){const s=stars[si];
  ...
  function drawAnimeAtmosphere(sun,sunAlt,night,light,t){
    ...
    ctx.fillStyle='#fff';const moteStep=quality==='high'?1:(adaptiveDetail<.7?3:2);for(let mi=0;mi<skyMotes.length;mi+=moteStep){const m=skyMotes[mi],a=(.025+.06*light+.09*night)*(.4+.6*Math.sin(t*m.s+m.p)**2);ctx.globalAlpha=a;ctx.beginPath();ctx.arc(m.x+Math.sin(t*.07+m.p)*7,m.y+Math.cos(t*.05+m.p)*5,m.r,0,TAU);ctx.fill()}
    ctx.restore();
  }
  ...
  function drawMovingWater(sun,moon,sunAlt,moonAlt,t){
    ...
    const waterLines=quality==='high'?50:Math.max(18,Math.round(30*adaptiveDetail));
    ctx.save();ctx.globalAlpha=.17;for(let i=0;i<waterLines;i++){const y=motionTop+7+i*(375/Math.max(1,waterLines)),shift=(t*(3.7+i*.07)+i*79)%120;ctx.strokeStyle=i%4===0?'rgba(210,235,255,.3)':'rgba(170,210,239,.15)';ctx.lineWidth=.55+(i%3)*.2;ctx.beginPath();for(let x=-120;x<W+120;x+=92){ctx.moveTo(x+shift,y+Math.sin(x*.017+t+i)*1.4);ctx.lineTo(x+shift+31+Math.sin(i)*12,y+Math.sin((x+50)*.017+t+i)*1.4)}ctx.stroke()}ctx.restore();
    const reflection=(orb,alt,col,intensity)=>{if(alt<-3)return;ctx.save();ctx.globalCompositeOperation='screen';const reflectionLines=quality==='high'?58:Math.max(20,Math.round(34*adaptiveDetail));for(let i=0;i<reflectionLines;i++){const y=motionTop+5+i*(278/Math.max(1,reflectionLines)),spread=10+i*(104/Math.max(1,reflectionLines)),wob=Math.sin(t*1.7+i*.81)*spread*.14;ctx.globalAlpha=intensity*(1-i/66)*(.18+.82*hash(i*17));ctx.strokeStyle=col;ctx.lineWidth=.8+hash(i)*2.1;ctx.beginPath();ctx.moveTo(orb.x-spread*.5+wob,y);ctx.lineTo(orb.x+spread*.5+wob,y);ctx.stroke()}ctx.restore()};
  ...
  function drawTraffic(amount,t){
    ...
    const carCount=quality==='high'?18:Math.max(6,Math.round(11*adaptiveDetail));for(let i=0;i<carCount;i++){car(((t*.018+i/carCount)%1),1,i%5===0?'#75e8ff':'#fff1bd');car((1-((t*.015+i/carCount+.35)%1)),-1,i%4===0?'#ff73ad':'#ffb37b')}
    ctx.restore();
  }
  ...
  function drawCityLights(amount,t){
    ...
    const cityStep=quality==='high'?1:(adaptiveDetail<.64?3:2);
    buildings.forEach((b,bi)=>{
      if(cityStep>1&&bi%cityStep!==0)return;
      const y=CITY_BASE-b.h,wx=b.w/(b.cols+1),wy=b.h/(b.rows+1);
      const rowStep=quality==='high'?1:(adaptiveDetail<.64?2:1);
      for(let r=1;r<=b.rows;r+=rowStep)for(let c=1;c<=b.cols;c++){
  ...
  function drawCityPolish(light,amount,t){
    ...
    if(amount>.08){
      cityGlowNodes.forEach((n,i)=>{if(quality!=='high'&&adaptiveDetail<.78&&i%2)return;const pulse=.78+.22*Math.sin(t*.21+n.p);const g=ctx.createRadialGradient(n.x,n.y,0,n.x,n.y,n.r);g.addColorStop(0,n.color+'24');g.addColorStop(.48,n.color+'10');g.addColorStop(1,n.color+'00');ctx.globalAlpha=amount*pulse;ctx.fillStyle=g;ctx.fillRect(n.x-n.r,n.y-n.r,n.r*2,n.r*2)});
  ...
  function drawShadows(sun,sunAlt,sleep){
    ...
    ctx.save();if(quality==='high')ctx.filter='blur(5px)';
  ...
  function drawTree(pal,t,light,wind=windValue(t)){
    ...
    const blossomStep=quality==='high'?1:(adaptiveDetail<.62?3:2);clusterPoints.forEach((cl,i)=>{if(i%blossomStep)return;const bob=Math.sin(t*.72+cl.p)*2+wind*(3+hash(i)*4.6),sprite=blossomSprites[i%3],size=(.38+hash(i*9)*.38)*Math.sqrt(blossomStep);ctx.save();ctx.globalAlpha=.78+.2*light;ctx.translate(cl.x+bob,cl.y+Math.cos(t*.61+cl.p)*1.2);ctx.rotate(wind*.023+Math.sin(t*.4+cl.p)*.014);ctx.drawImage(sprite,-sprite.width*size/2,-sprite.height*size/2,sprite.width*size,sprite.height*size);if(i%3===0){ctx.globalAlpha*=.58;ctx.translate(12+hash(i)*15,-8+hash(i*2)*12);ctx.scale(.72,.72);ctx.drawImage(sprite,-sprite.width*size/2,-sprite.height*size/2,sprite.width*size,sprite.height*size)}ctx.restore()});
    ctx.restore();
  }
  ...
  function updateUI(date,times,character){
    const now=performance.now();if(now-lastClock>400){lastClock=now;const timeEl=document.getElementById('current-time'),dateEl=document.getElementById('current-date'),loc=document.getElementById('location-label'),precise=Boolean(sessionStorage.getItem('sd-sky-coords-v3')),formatters=getWorldFormatters(),fmtTime=d=>d?formatters.time.format(d):'—';if(timeEl)timeEl.textContent=fmtTime(date);if(dateEl)dateEl.textContent=formatters.date.format(date);if(loc)loc.innerHTML=`<i></i>${mode==='preview'?'24-HOUR PREVIEW':precise?'PRECISE LOCAL SKY':'LOCAL SKY ESTIMATE'} • Sunrise ${fmtTime(times.sunrise)} • Sunset ${fmtTime(times.sunset)}`;const out=document.getElementById('v17-scrub-output');if(out)out.value=fmtTime(date);const slider=document.getElementById('v17-scrub');if(slider&&mode==='preview'&&!slider.matches(':active'))slider.value=previewMinutes}
  ...
  function render(perf){
    ...
    if(styleStamp!==render._styleStamp){render._styleStamp=styleStamp;
